...
`@monolith/*` harness 包之间的 peer 依赖关系。peer 表示消费端需要提供共享实例，不包括普通运行时 dependency 或仅开发期关系。该图按 `packages/<group>/<pkg>` 层级分组；边 `a --> b` 表示包 `a` peer 依赖包 `b`。名称中的 `@monolith/` 前缀已移除。
...
flowchart TD
  ...
  subgraph group_subagent["packages/subagent"]
    ...
    pkg_subagent_monolith_sdk["subagent-monolith-sdk"]
  ...
  subgraph group_monolith["packages/monolith"]
    pkg_bundle["bundle"]
  ...
  pkg_subagent_monolith_sdk --> pkg_agent
  pkg_subagent_monolith_sdk --> pkg_llm
  pkg_subagent_monolith_sdk --> pkg_sdk_client
  pkg_subagent_monolith_sdk --> pkg_session
  pkg_subagent_monolith_sdk --> pkg_subagent
  pkg_subagent_monolith_sdk --> pkg_subprocess
```
...
| [`bundle`](../packages/monolith/bundle) | `monolith` | — |
| [`client-ui-brand`](../packages/monolith/ui-brand) | `monolith` | — |
...
| [`subagent-monolith-sdk`](../packages/subagent/subagent-monolith-sdk) | `subagent` | [`agent`](../packages/core/agent), [`llm`](../packages/llm/llm), [`sdk-client`](../packages/sdk/client), [`session`](../packages/core/session), [`subagent`](../packages/subagent/subagent), [`subprocess`](../packages/subprocess/subprocess) |
