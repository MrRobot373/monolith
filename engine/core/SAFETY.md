...
MONOLITH is experimental developer-preview software. It has not undergone a security audit and must not be treated as secure or production-ready.
...
Do not rely on MONOLITH as the sole security control for untrusted workloads.
