import { Context, Service, type Plugin } from '@monolith/cordis'
import type { Dict } from '@monolith/cosmokit'
import { ModuleLoader, type ModuleJob, type ResolveResult } from '@monolith/cordis-plugin-loader'
...
import type {} from '@monolith/cordis-plugin-timer'
...
namespace Hmr {
  ...
  // [monolith] vendored modification: removed `.i18n({ 'en-US': enUS, 'zh-CN': zhCN })`
