import { EntryGroup, EntryTree, isJsExpr, type EntryOptions } from '@monolith/cordis-plugin-loader'
 ...
 * (`monolith --dump-config`) parses and prints exactly the dialect this include
 * mounts.
 */
 ...
 * (`monolith --dump-config`) so a dump can never drift from what boots. The input
