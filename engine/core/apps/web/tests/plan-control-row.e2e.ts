...
// regression the external report asked for (monolith-external/issues#107 →
// monolith#1406): "increase an 800×720 browser regression test and
...
import type {} from '@monolith/plan-mode'
