...
import type { SessionEvent, SessionId } from '@monolith/session'
import type {} from '@monolith/goal'
import {
...
const PACKAGE_FILES: Readonly<Record<string, string>> = {
  ...
  'packages/client/ui-conversation/package.json': '{"name":"@monolith/client-ui-conversation"}\n',
  ...
  'packages/context/session-reference/package.json': '{"name":"@monolith/session-reference"}\n',
  ...
  'packages/llm/token-meter/package.json': '{"name":"@monolith/token-meter"}\n',
  ...
  'packages/skill/skill-filesystem/package.json': '{"name":"@monolith/skill-filesystem"}\n',
