...
import { WEB_SEARCH_MAX_RESULTS } from '@monolith/tool-web'
import {
...
const QUERIES = ['MONOLITH snapshot search', 'MONOLITH multi-query search'] as const
const PROMPT = `Use web_search once with queries ${JSON.stringify(QUERIES)}. Then reply exactly SEARCH_DONE and stop.`
const SEARCH_CREDENTIAL_REF = credentialRef('MONOLITH_WEB_SEARCH_E2E_KEY')
