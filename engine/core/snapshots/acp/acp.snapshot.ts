/** Recorded ACP protocol behavior through the shipped `monolith --profile acp` interface. */
    ...
    ...manifest.permission === undefined && manifest.environment === undefined
      ...
      : {
          env: {
            ...
            ...(manifest.permission === undefined ? {} : { MONOLITH_PERMISSION_MODE: manifest.permission }),
          },
        },
  }
})
