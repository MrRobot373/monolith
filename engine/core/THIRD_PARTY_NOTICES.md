...
| --- | --- | --- | --- |
| `@monolith/cosmokit` | `cosmokit` | [github.com/monolith/cosmokit](https://github.com/monolith/cosmokit) | MIT |
| `@monolith/schemastery` | `schemastery` | [github.com/monolith/schemastery](https://github.com/monolith/schemastery) | MIT |
| `@monolith/cordis` | `cordis` | [github.com/cordiverse/cordis](https://github.com/cordiverse/cordis) | MIT |
| `@monolith/cordis-plugin-loader` | `@cordisjs/plugin-loader` | [github.com/cordiverse/cordis](https://github.com/cordiverse/cordis) | MIT |
| `@monolith/cordis-plugin-include` | `@cordisjs/plugin-include` | [github.com/monolith/cordis](https://github.com/monolith/cordis) | MIT |
| `@monolith/cordis-plugin-group` | `@cordisjs/plugin-group` | [github.com/monolith/cordis](https://github.com/monolith/cordis) | MIT |
| `@monolith/cordis-plugin-timer` | `@cordisjs/plugin-timer` | [github.com/monolith/cordis](https://github.com/monolith/cordis) | MIT |
| `@monolith/cordis-plugin-hmr` | `@cordisjs/plugin-hmr` | [github.com/monolith/cordis](https://github.com/monolith/cordis) | MIT |
| `@monolith/cordis-plugin-logger-console` | `@cordisjs/plugin-logger-console` | [github.com/monolith/cordis](https://github.com/monolith/cordis) | MIT |
...
`eslint-plugin-sonarjs` (LGPL-3.0-only) and `lightningcss` (MPL-2.0) run only as development tooling; their code is not linked into or distributed with any MONOLITH artifact.
...
| [`pydantic`](https://github.com/pydantic/pydantic) | MIT | runtime dependency of `monolith-sdk` |
