/**
 * Unit + real-load-path coverage for @monolith/tool-call-timeout-policy. The
...
import { ToolCallId, HarnessError } from '@monolith/llm'
import SystemPrompt from '@monolith/system-prompt'
import ToolRuntime, { defineContentToolFixture, TOOL_ABORTED, type ToolExecutionInput, type PostToolDecision } from '@monolith/tools'
import * as timeoutPolicy from '@monolith/tool-call-timeout-policy'
import { TOOL_TIMEOUT } from '@monolith/tool-call-timeout-policy'
...
describe('monolith-tool-call-timeout-policy real-load-path guard', () => {
