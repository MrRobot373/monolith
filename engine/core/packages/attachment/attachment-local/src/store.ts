 ...
 * @param root - absolute `MONOLITH_HOME/attachments/v1` root.
...
/**
 * Establish this process's proof that one MONOLITH_HOME entry and every ancestor
...
export async function commitPreparedImageFile(
  ...
  // Establish MONOLITH_HOME itself against the filesystem root once per process.
