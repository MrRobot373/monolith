...
import type { AttachmentStore } from '@monolith/attachment'
import { admitEncodedImages, admitPromptContent } from '@monolith/attachment'
import type { ImageAttachmentRef, SaveImageAttachment } from '@monolith/attachment/types'
