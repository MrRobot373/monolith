...
Indirectly, through the consumer that records a canonical zone on a durable message, from which `monolith-time-context` renders the turn's model-visible zone instruction and timestamp.
