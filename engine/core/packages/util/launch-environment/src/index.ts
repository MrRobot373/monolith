 ...
 * @module @monolith/launch-environment
 */
 ...
 * this process inherited, the invoking directory's `.env`, the MONOLITH home's
 * `.env`.
 */
...
export const MONOLITH_LAUNCH_ENVIRONMENT_KEY = 'launchEnvironment'
...
export function launchEnvironmentOf(ctx: Context): LaunchEnvironmentSnapshot {
  return ctx.get(MONOLITH_LAUNCH_ENVIRONMENT_KEY)
