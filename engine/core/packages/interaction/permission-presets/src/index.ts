 ...
 * `/permission` command.
 *
 * @module monolith-permission-presets
 */
...
import type { SandboxMode } from '@monolith/sandbox'
import { SANDBOX_MODES, setSandboxMode } from '@monolith/sandbox-policy'
...
import type {} from '@monolith/shell'
import type { ApprovalPolicy } from '@monolith/user-approval'
import { APPROVAL_POLICIES, setApprovalPolicy } from '@monolith/user-approval'
...
import type {} from '@monolith/commands'
