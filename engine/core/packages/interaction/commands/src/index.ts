 ...
 * @module @monolith/commands
 */

import { Context } from '@monolith/cordis'
import { randomUUID } from '@monolith/util-crypto'
import type { Agent } from '@monolith/agent'
import { AttachmentError, admitEncodedImages } from '@monolith/attachment'
import type { EncodedImageAttachment } from '@monolith/attachment/types'
import type { ImageBlock } from '@monolith/llm'
import { NamedEntries, ScopedLayers } from '@monolith/scope'
import type { ScopeKey, ScopeLayer } from '@monolith/scope'
import { SessionSeq } from '@monolith/session'
import type { Session, SessionEvent, SessionEventMap } from '@monolith/session'
import { TypertRemoteService, Remote } from '@monolith/typert-protocol'
