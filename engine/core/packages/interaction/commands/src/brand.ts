/**
 * monolith-commands' owned branded id: command lifecycle pairing across the
 * session log, the wire admission response, and client-side flow pairing.
 *
 * The `Branded<B>` primitive lives in `@monolith/brand`; this module
 ...
 * loading the host plugin's Context merges — the `monolith-llm/brand` shape.
 *
 * @module @monolith/commands/brand
 */
