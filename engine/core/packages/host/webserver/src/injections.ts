...
/**
 * Tail script settling the boot-readiness deferred (`__MONOLITH_BOOT_READY__`):
 ...
 */
const READY_MARKUP = '<script>(globalThis.__MONOLITH_BOOT_READY__ ??= Promise.withResolvers()).resolve()</script>'
