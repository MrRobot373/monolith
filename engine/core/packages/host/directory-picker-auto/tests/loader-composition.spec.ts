...
import HttpServer from '@monolith/host-webserver'
import type { DirectoryPicker } from '@monolith/host-directory-picker'
import BrowseDirectoryPicker from '@monolith/host-directory-picker-browse'
import NativeDirectoryPicker from '@monolith/host-directory-picker-native'
...
const AUTO = '@monolith/host-directory-picker-auto'
const NATIVE = '@monolith/host-directory-picker-native'
const BROWSE = '@monolith/host-directory-picker-browse'
const NATIVE_SURFACE = '@monolith/client-ui-directory-picker-native'
const BROWSE_SURFACE = '@monolith/client-ui-directory-picker-browse'
...
async function loadComposition(
  ...
  root = await mkdtemp(join(tmpdir(), 'monolith-directory-picker-auto-'))
  ...
  const modules = new Map<string, unknown>([
    ['@monolith/host-webserver', HttpServer],
...
function stubAttendedHost(): void {
  fakeBin = mkdtempSync(join(tmpdir(), 'monolith-picker-bin-'))
