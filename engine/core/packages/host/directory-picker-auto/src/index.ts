 ...
 * @module @monolith/host-directory-picker-auto
 */
...
export const BACKEND_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@monolith/host-directory-picker-native',
  browse: '@monolith/host-directory-picker-browse',
}
...
export const SURFACE_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@monolith/client-ui-directory-picker-native',
  browse: '@monolith/client-ui-directory-picker-browse',
}
