 ...
 * and leaves presentation to `@monolith/tool-web`. Requests carry no browser cookies
 * or ambient credentials.
 * @module @monolith/web-fetch-http/provider
 */

import { WebError } from '@monolith/web'
import type { WebFetchBody, WebFetchProvider, WebFetchRequest, WebFetchResult } from '@monolith/web'
