...
import type { GenericCallView, ToolResult, WebFetchResultView } from '@monolith/tools'
import type { WebFetchBody, WebFetchResult } from '@monolith/web'
import { assertNever, type JsonValue } from '@monolith/util-values'
 ...
 * `@monolith/tool-call-timeout-policy`, not a model argument.
 *
 ...
 *   `ToolDefinition.timeoutMs` for `@monolith/tool-call-timeout-policy` to enforce.
