...
- [Generated configuration catalog](../../../docs/config-catalog.md#monolith-subagent-claude-code) — every accepted config field and its source declaration.
