...
| [`subagent-monolith-sdk/`](subagent-monolith-sdk/README.md) | Runs an out-of-process MONOLITH child through the TypeScript SDK | registers on `ctx.subagents` |
