 ...
 * `@monolith/tool-subagent` instances so multiple delegation tools share
 * one control API.
 * @module @monolith/tool-subagent-control
 */
...
import { markAdjacentAgentSendMessageTool } from '@monolith/subagent/internal'
