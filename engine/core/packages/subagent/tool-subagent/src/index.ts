 ...
 * @module @monolith/tool-subagent
 */

import type { Context } from '@monolith/cordis'
import z from '@monolith/schemastery'
import { scopeChainOf, scopeOf } from '@monolith/scope'
...
import type { SubagentProvider, SubagentResult, SubagentRun } from '@monolith/subagent'
import type { JobOutcome } from '@monolith/jobs'
import {
...
export function apply(ctx: Context, config: Config): void {
  ...
  if (settings === undefined) {
    throw new Error(
      ...
      + '@monolith/tool-subagent/model-selection-settings in the Host scope',
    )
  }
