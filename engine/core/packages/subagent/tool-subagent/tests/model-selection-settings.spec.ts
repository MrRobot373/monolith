...
import { bindScopeParent, createScope, scopeOf, scopeTarget } from '@monolith/scope'
import { SettingsProvider } from '@monolith/settings'
import type { SettingsNamespace } from '@monolith/settings'
...
describe('SubagentModelSelectionConfig', () => {
  ...
  it('requires both the Host setting owner and a composition scope', async () => {
    ...
    }).toThrow('requires @monolith/tool-subagent/model-selection-settings')
