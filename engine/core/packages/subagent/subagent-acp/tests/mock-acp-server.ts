 ...
 * `monolith-subagent-acp` tests. It speaks the agent side of ACP over stdio and is
 ...
 *
 * @module @monolith/subagent-acp/tests/mock-acp-server
 */
...
createAcpAgentApp({ name: 'monolith-subagent-acp-test-agent' })
