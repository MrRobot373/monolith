 ...
 * @module @monolith/subagent/internal
 */
...
export const adjacentAgentSendMessageTool = Symbol.for('monolith.subagent.adjacentAgentSendMessageTool')
 ...
 * @internal
 */
export const deliverSubagentPrompt = Symbol.for('monolith.subagent.deliverPrompt')
