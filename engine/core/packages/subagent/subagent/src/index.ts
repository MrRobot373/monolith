 ...
 * (`@monolith/subagent-spawn-in-process`, `-fork`, `-acp`) and the model-facing
 * consumer (`@monolith/tool-subagent`) are separate packages.
 *
...
import { admitPromptContent } from '@monolith/attachment'
import { scopeTarget } from '@monolith/scope'
import type { Scoped } from '@monolith/scope'
import { assertObjectJsonSchema } from '@monolith/tools'
