 ...
 * @module @monolith/subagent-in-process-driver/structured
 */

import type { Context } from '@monolith/cordis'
import type { ToolSchema } from '@monolith/llm'
import type { ToolExecution, ToolRunContext } from '@monolith/tools'
import { ToolArgsError, validateJsonSchemaValue, type ObjectJsonSchema } from '@monolith/tools'
 ...
 *   `assertObjectJsonSchema` in monolith-tools).
