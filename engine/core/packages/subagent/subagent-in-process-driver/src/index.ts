 ...
 * one result.
 *
 * @module @monolith/subagent-in-process-driver
 */

import { randomUUID } from 'node:crypto'
import type { Context } from '@monolith/cordis'
import { brandString } from '@monolith/brand'
import { foldConsumedWork } from '@monolith/agent'
import type { Agent, AgentHandle } from '@monolith/agent'
import { SessionLogOffset } from '@monolith/session'
import type { SessionEvent, SessionId, SessionLogOffset as SessionLogOffsetType, TurnEndReason } from '@monolith/session'
import { createUserMessage, type ContentBlock } from '@monolith/llm'
import {
