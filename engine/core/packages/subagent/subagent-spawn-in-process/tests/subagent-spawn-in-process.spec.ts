...
import { Context, symbols, type EffectMeta } from '@monolith/cordis'
...
import SubagentRuntime, { type SubagentStartRequest } from '@monolith/subagent'
import SessionProjectionRegistry from '@monolith/session-projection'
import { MockAdapter, maxTokensResponse, textResponse, toolCallResponse } from '../../../core/agent-loop/tests/mock-adapter.ts'
import * as spawn from '../src/index.ts'
import { STRUCTURED_OUTPUT_TOOL } from '@monolith/subagent-in-process-driver'
...
describe('monolith-subagent-spawn-in-process', () => {
