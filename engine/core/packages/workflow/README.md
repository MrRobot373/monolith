...
- [Generated tool catalog](../../docs/tool-catalog.md#monolith-tool-workflow) — the `workflow` tool schema the model receives.
- [Generated tool catalog](../../docs/tool-catalog.md#monolith-tool-ralph) — the `ralph` tool schema the model receives.
- [Generated configuration catalog](../../docs/config-catalog.md#monolith-workflow-worker-thread) — every accepted engine config field.
