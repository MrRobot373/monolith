...
The generated [configuration catalog](../../../docs/config-catalog.md#monolith-storage-domain) is the exhaustive source for every accepted field and its JSDoc.
