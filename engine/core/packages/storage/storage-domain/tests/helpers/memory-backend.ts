 ...
 *
 * Fidelity to the backend contract (`monolith-storage` `src/backend.ts`): version
...
import { StorageError } from '@monolith/storage'
import type { KvFacet, KvUnit, KvUnitDescriptor, StorageBackend } from '@monolith/storage'
