...
import Storage, { storageBackendServiceKey } from '@monolith/storage'
import type { KvUnitDescriptor } from '@monolith/storage'
...
async function freshDbPath(): Promise<string> {
  const dir = await mkdtemp(join(tmpdir(), 'monolith-storage-sqlite-'))
  dirs.push(dir)
