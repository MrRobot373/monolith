...
The generated [configuration catalog](../../../docs/config-catalog.md#monolith-storage-json) is the exhaustive source for every accepted field and its JSDoc.
