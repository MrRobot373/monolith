 ...
 *
 * @module @monolith/agent-instructions/config
 */
...
export interface Config {
  /** MONOLITH home containing the fixed user-global `AGENTS.md`; defaults to `$MONOLITH_HOME` or `~/.monolith`. */
  monolithHome?: string
...
export function resolveDiscoveryConfig(
  config: Pick<Config, 'monolithHome' | 'projectRootMarkers' | 'instructionFileCandidates' | 'localInstructionFileCandidates'>,
): ResolvedDiscoveryConfig {
  return {
    monolithHome: resolveMonolithHome(config.monolithHome),
