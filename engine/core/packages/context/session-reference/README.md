...
The generated [configuration catalog](../../../docs/config-catalog.md#monolith-session-reference) is the exhaustive source for every accepted field and its JSDoc.
...
| [`src/uri.ts`](src/uri.ts) | `monolith-session:` URI codec, mention formatting and parsing |
...
- [Generated configuration catalog](../../../docs/config-catalog.md#monolith-session-reference) — every accepted config field and its source declaration.
