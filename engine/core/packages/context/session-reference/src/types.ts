 ...
 * @module @monolith/session-reference/types
 */

import type { UserMessage } from '@monolith/llm/message'
import type { ContentBlock } from '@monolith/llm/types'
import type { OptionalSessionSeq, SessionId } from '@monolith/session/types'
...
export interface SessionReferenceMentionCandidate extends SessionReferenceCandidate {
  /** Canonical `@[label](monolith-session:…)` mention serialized into the prompt draft. */
  mention: string
}
