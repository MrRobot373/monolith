...
import { isCompactCheckpointSource } from '@monolith/compaction'
import type { SessionSurfaceSnapshot } from '@monolith/session-query'
...
import type { OptionalSessionSeq } from '@monolith/session'
