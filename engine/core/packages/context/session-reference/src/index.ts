 ...
 *
 * @module @monolith/session-reference
 */
...
import { createUserMessage, freezeMessage } from '@monolith/llm'
import type { ContentBlock, UserMessage } from '@monolith/llm'
...
import type { ProjectionSnapshot } from '@monolith/session-projection'
import type {} from '@monolith/session-projection-cache'
import type {} from '@monolith/session-title'
import type { SessionRecord, SessionSurfaceSnapshot } from '@monolith/session-query'
import {
