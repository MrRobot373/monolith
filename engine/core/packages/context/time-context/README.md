...
The generated [configuration catalog](../../../docs/config-catalog.md#monolith-time-context) is the exhaustive source for every accepted field and its JSDoc.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#monolith-time-context) — every accepted config field and its source declaration.
