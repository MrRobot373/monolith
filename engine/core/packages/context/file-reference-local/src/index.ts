 ...
 *
 * @module @monolith/file-reference-local
 */
...
export { FILE_REFERENCE_PROMPT } from '@monolith/file-reference'
export { activeAtToken, formatFileMention } from '@monolith/file-reference/grammar'
