...
import GoalService, { GoalId, applyGoalProjection, foldGoal, goalProjectionDefinition } from '@monolith/goal'
import type { GoalProjection, GoalProjectionState, GoalRef } from '@monolith/goal'
