...
import SessionStore, { Session, SessionId, type UserMessage } from '@monolith/session'
...
import type { GoalChangeMeta, GoalRef, GoalSnapshotChangeMeta } from '@monolith/goal'
...
function stubAgent(rawId: string, seed?: readonly import('@monolith/session').SessionEvent[]): StubAgent {
