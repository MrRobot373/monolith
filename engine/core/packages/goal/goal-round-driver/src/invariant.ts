/** Package-owned goal-round prompt invariants. @module @monolith/goal-round-driver/invariant */

import { isDeepStrictEqual } from 'node:util'
import type { Context } from '@monolith/cordis'
import { foldGoal, type FoldedGoal, type GoalMessageSource, type GoalView } from '@monolith/goal'
...
const PACKAGE_NAME = '@monolith/goal-round-driver'
