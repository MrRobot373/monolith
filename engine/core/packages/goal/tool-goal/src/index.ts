 ...
 * @module @monolith/tool-goal
 */

import type { Context } from '@monolith/cordis'
import z from '@monolith/schemastery'
import { GoalId } from '@monolith/goal'
import type { GoalRef, GoalView } from '@monolith/goal'
import { boundContextSummary, createUserMessage, HarnessError } from '@monolith/llm'
import { defineTool } from '@monolith/tools'
import type { GenericCallView } from '@monolith/tools'
import {
  completionAuthority,
  goalToolExecution,
  requireDirectHuman,
