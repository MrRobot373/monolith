...
- id: delegation
  ...
  config:
    - id: workflow-worker-thread
      name: '@monolith/workflow-worker-thread'
      config:
        provider: spawn
    - id: tool-workflow
      name: '@monolith/tool-workflow'
```
