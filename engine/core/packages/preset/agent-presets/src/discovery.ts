 ...
 * @module @monolith/agent-presets/discovery
 */
...
import { expandHomePath } from '@monolith/home-paths'
...
/**
 * MONOLITH-home directory holding locally authored presets.
 *
 * This package owns the writable root the way `monolith-skill-filesystem` owns
 * `<monolithHome>/skills`: where a person's own presets go is the same place in
