 ...
 * @module @monolith/agent-presets/composition-inventory
 */

import { readFile } from 'node:fs/promises'
import { load } from 'js-yaml'
import type { FiberState } from '@monolith/cordis'
import { isJsExpr, type EntryTree } from '@monolith/cordis-plugin-loader'
