 ...
 *
 * `monolith-system-prompt` owns the global persona as its own config, and registers
 ...
 * exactly like the per-child persona `monolith-subagent` installs; mounted globally
