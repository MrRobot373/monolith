 ...
 * `@monolith/output-retention` (`TextRetainer`), storage is `ctx.spillStore`.
...
import type { PostToolDecision, ToolExecution } from '@monolith/tools'
