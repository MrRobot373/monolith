...
const KEY = credentialRef('MONOLITH_CRED_PIPE')
...
async function tempDir(): Promise<string> {
  const dir = await mkdtemp(join(tmpdir(), 'monolith-credentials-watch-'))
