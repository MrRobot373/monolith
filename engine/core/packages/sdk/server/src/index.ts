/**
 * SDK-facing JSON-RPC plugin over stdio. The selected monolith profile decides
 ...
 *
 * @module @monolith/sdk-jsonrpc-server
 */

import type { Context } from '@monolith/cordis'
import type { Readable, Writable } from 'node:stream'
import Schema from '@monolith/schemastery'
import { JsonRpcLineTransport } from '@monolith/sdk-protocol'
