/**
 * Shared wire protocol for the MONOLITH SDK runtime: the
 ...
 * (`@monolith/sdk-jsonrpc-server`) serves this protocol; SDK clients
 * (`@monolith/sdk-client`, the Python SDK) drive it.
 *
 * @module @monolith/sdk-protocol
 */
