...
import type { WorkspaceRemote } from '@monolith/api-workspace-controller/client'
import type { WorkspaceFollowFrame } from '@monolith/api-workspace-controller/types'
import type { RemoteFailure, RemoteResult } from '@monolith/typert-protocol'
import {
  RemoteStream,
  type RemoteStreamOptions,
} from '@monolith/api-gateway/client'
