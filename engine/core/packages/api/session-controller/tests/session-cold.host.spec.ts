...
import SessionStore from '@monolith/session'
import AgentRegistry from '@monolith/agent'
import { SessionHistoryController } from '@monolith/api-session-controller/src/history.ts'
import { subagentIdentityProjectionDefinition } from '@monolith/subagent/src/projection.ts'
import TypertRegistry from '@monolith/typert-registry'
import { createUserMessage, MessageId } from '@monolith/llm'
import { snapshotSubagentDescriptor } from '@monolith/subagent'
import type { Agent } from '@monolith/agent'
import type { Session, SessionEvent, SessionHeader, SessionId } from '@monolith/session'
import type { SessionPromptRequest, SessionRequestId } from '../src/types.ts'
import {
  SessionPersistenceRevision,
  type SessionPersistenceSnapshot,
} from '@monolith/session-persistence'
...
describe('Remote Agent and Session lookup policy', () => {
  it('deduplicates a cold resume across Agent and Session parameters', async () => {
    ...
    const resumedSession = { id: sessionId, header: meta, events: [] } as unknown as import('@monolith/session').Session
