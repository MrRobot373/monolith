...
import type { Agent, ModelSelection as AgentModelSelection } from '@monolith/agent'
import { AttachmentError, admitPromptContent } from '@monolith/attachment'
import type { ImageAttachmentRef } from '@monolith/attachment'
import {
  ReasoningEffortId, createUserMessage, freezeMessage,
} from '@monolith/llm'
import type { MessageSource } from '@monolith/llm'
import { SessionLogOffset, SessionSeq } from '@monolith/session'
import type { SessionEvent, SessionHeader, SessionId, UserMessage } from '@monolith/session'
import { SessionQueryError, type SessionObservation } from '@monolith/session-query'
import { SessionTitleInvalidError } from '@monolith/session-title'
import { canonicalClientTimeZone } from '@monolith/util-time'
import { RemoteError, remoteErrorOf } from '@monolith/typert-protocol'
import type { Workspace } from '@monolith/workspace'
import {
