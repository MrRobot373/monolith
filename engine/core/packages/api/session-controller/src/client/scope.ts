 ...
 * Agent's identity. The mechanism mirrors the host `monolith-scope` architecture
...
import type { TypertRemoteScopeApi } from '@monolith/typert-protocol'
...
const kScope = Symbol('monolith.client.scope')
