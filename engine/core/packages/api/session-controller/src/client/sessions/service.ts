 ...
 */
import type { Context, Fiber } from '@monolith/cordis'
import type { SubagentAddress } from '@monolith/subagent/client'
...
import type { SessionProjectionMap } from '@monolith/session-projection/types'
import {
  createSnapshotStore, type SnapshotStore,
} from '@monolith/client-store'
import type { RemoteFailure, RemoteResult } from '@monolith/typert-protocol'
...
// monolith-scope, keyed by Agent identity); re-exported here so existing
...
export class ClientSessions implements ISessions {
  ...
  constructor(
    ...
    this.selection = createSnapshotStore<SessionSelection>(
      {},
      { persist: { name: 'monolith.sessions.current' } })
