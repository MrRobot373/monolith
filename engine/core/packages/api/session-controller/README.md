...
The generated [configuration catalog](../../../docs/config-catalog.md#monolith-api-session-controller) is the exhaustive source for accepted fields and their JSDoc.
