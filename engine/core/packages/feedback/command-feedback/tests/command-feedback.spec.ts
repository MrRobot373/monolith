...
import SessionStore, { foldSurface, Session, SessionId } from '@monolith/session'
import { SessionTelemetryBackend, type SessionTelemetrySharingStatus } from '@monolith/session-telemetry'
...
vi.mock('@monolith/anonymous-user-id', () => ({
...
describe('@monolith/command-feedback registration', () => {
