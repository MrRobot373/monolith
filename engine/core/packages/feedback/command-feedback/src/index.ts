 ...
 * @module @monolith/command-feedback
 */

import type { Context } from '@monolith/cordis'
import type { CommandInvocation, CommandResult } from '@monolith/commands'
import type { SessionTelemetryBackend, SessionTelemetrySharingStatus } from '@monolith/session-telemetry'
