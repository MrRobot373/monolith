/**
 * @monolith/cmdline — the command line a monolith launcher hands to the app
 * it boots.
 *
 ...
 * verbatim and in argv order. `monolith --profile tui --resume abc` yields
 * `['--resume', 'abc']`.
 */
