...
import { installModelSelection, type ModelSelection, type ModelSelectionRef } from '@monolith/agent'
import { ReasoningEffortId, type LlmCallConfig, type LlmRuntime } from '@monolith/llm'

const MODEL_CONFIG_ID = 'model'
const REASONING_CONFIG_ID = 'reasoning_effort'
// MONOLITH reasoning effort ids are non-empty, so the empty opaque ACP value is a disjoint provider-default choice.
