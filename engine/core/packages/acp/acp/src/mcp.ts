/** Standard ACP MCP-server declarations translated into Agent-scoped MONOLITH MCP clients. */
...
import * as McpClient from '@monolith/mcp-client'
...
/** Produce a stable MONOLITH tool namespace from ACP's human-readable server name. */
