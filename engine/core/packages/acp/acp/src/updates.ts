/** Standard ACP updates derived from committed MONOLITH session events. */
 ...
 * @param event - committed MONOLITH tool-call event.
 ...
 * @param event - committed MONOLITH tool-result event.
...
/** Report current context occupancy only when MONOLITH has both usage and capacity facts. */
