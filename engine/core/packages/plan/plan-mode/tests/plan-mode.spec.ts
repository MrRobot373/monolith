...
import ToolRuntime, { RUN_CODE_NAME, defineContentToolFixture } from '@monolith/tools'
import { Session, SessionId, type SessionEvent, type UserMessage } from '@monolith/session'
import AgentRegistry, { agentEvents, type Agent } from '@monolith/agent'
import { createScope } from '@monolith/scope'
import UserQuestionService, {
  UserQuestionError, type AskUserQuestionAnswer, type AskUserQuestionRequest,
} from '@monolith/user-questions'
import CommandRuntime from '@monolith/commands'
import { CodeRuntime, type CodeRunRequest, type CodeRunResult } from '@monolith/code-runtime'
...
/**
 * Drives the REAL plugin: mounts `monolith-plan-mode` beside real `SystemPrompt` and
