 ...
 * mapping; shared execution and parsing live in `monolith-hook-protocol`.
 ...
 * @module @monolith/hooks-claude-code
 */

import { readFileSync } from 'node:fs'
import type { Context } from '@monolith/cordis'
import z from '@monolith/schemastery'
import type { Agent, PreStepDecision, TurnBoundaryProjection } from '@monolith/agent'
import type {} from '@monolith/session-projection'
import { createUserMessage } from '@monolith/llm'
import type { ContentBlock, MessageSource } from '@monolith/llm'
import type { UserMessage } from '@monolith/session'
import type { PostToolDecision, PreToolDecision, ToolExecution, ToolExecutionResult } from '@monolith/tools'
import {
  appendHookInvoked,
  appendHookResult,
  createDetachedRuns,
