...
import { createMessage } from '@monolith/llm'
...
import * as SessionStatsPlugin from '@monolith/session-stats'
import { sessionStatsProjectionDefinition } from '@monolith/session-stats/src/projection.ts'
import type { SessionStatsProjection } from '@monolith/session-stats/types'
