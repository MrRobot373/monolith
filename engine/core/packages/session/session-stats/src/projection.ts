 ...
 * (`deriveStats` in monolith-client-ui-conversation, that fold's whole-window
 ...
 *
 * @module @monolith/session-stats/projection
 */

import { z } from 'zod'
import type { StreamChunk } from '@monolith/llm/types'
