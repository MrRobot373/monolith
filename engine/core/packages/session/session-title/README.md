...
The generated [configuration catalog](../../../docs/config-catalog.md#monolith-session-title) is the exhaustive source for every accepted field and its JSDoc.
