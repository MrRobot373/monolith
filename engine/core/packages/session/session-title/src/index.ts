 ...
 * @module @monolith/session-title
 */

import { Context, FiberState, Service, type Fiber } from '@monolith/cordis'
import z from '@monolith/schemastery'
import { z as zod } from 'zod'
import type { ZodType } from 'zod'
import type { Branded } from '@monolith/brand'
import { isAgentLoopRequest } from '@monolith/llm'
import type { GenerateOptions } from '@monolith/llm'
import { assertNever, deepFreeze } from '@monolith/util-values'
import type {
  Session,
  SessionEvent,
