...
# @monolith/session-telemetry-otel
...
- id: sessionTelemetry-otel
  name: '@monolith/session-telemetry-otel'
  config:
...
- [Generated configuration catalog](../../../docs/config-catalog.md#monolith-session-telemetry-otel) — every accepted config field and its source declaration.
