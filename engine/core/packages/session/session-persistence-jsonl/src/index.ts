 ...
 * @module @monolith/session-persistence-jsonl
 */
...
import type { SessionEvent, SessionId, SessionHeader, SessionLogOffset as SessionLogOffsetType } from '@monolith/session'
import {
