...
# @monolith/session-persistence-jsonl
...
The generated [configuration catalog](../../../docs/config-catalog.md#monolith-session-persistence-jsonl) is the exhaustive source for every accepted field and its JSDoc.
