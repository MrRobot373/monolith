...
import { defineStore } from '@monolith/client-store'
import type { WorkspaceId } from '@monolith/api-workspace-controller/client'
import type { SessionId } from '@monolith/session/types'
import type { PropsRenderSlots, SessionStandardProps } from '@monolith/client-ui-slots'
import { SlotTestRuntime } from '@monolith/client-test-runtime'
