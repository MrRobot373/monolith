 ...
 *
 * @module @monolith/compaction-basic
 */

import { Context } from '@monolith/cordis'
import z from '@monolith/schemastery'
import { CompactionEngine, ManualCompactionError } from '@monolith/compaction'
import type { CompactionResult, CompactionTrigger } from '@monolith/compaction'
import type { TokenMeter } from '@monolith/token-meter'
import type { Session, SessionSeq } from '@monolith/session'
import { CONTEXT_WINDOW_EXCEEDED_CODE } from '@monolith/llm'
import type { LlmCallConfig } from '@monolith/llm'
import { assertNever } from '@monolith/util-values'
import type { Agent, PreStepDecision } from '@monolith/agent'
import type { CommandId } from '@monolith/commands/brand'
// Type-only: makes the optional sibling service available to `ctx.get()`.
import type {} from '@monolith/compaction-tool-result-pruner'
import {
  resolveCompactSpec,
  resolveConfig,
  resolveTargetPolicy,
