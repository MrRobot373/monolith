 ...
 *
 * @module @monolith/compaction-basic/summarizer
 */

import type { Context } from '@monolith/cordis'
import { contentHasImage, createUserMessage, BlockAssembler, LlmError } from '@monolith/llm'
import type {
...
export async function summarizeWithLlm(
  ...
  const messages: Message[] = [
    ...
    createUserMessage({
      ...
      source: { kind: 'plugin', plugin: 'monolith-compaction-basic' },
    }),
  ]
