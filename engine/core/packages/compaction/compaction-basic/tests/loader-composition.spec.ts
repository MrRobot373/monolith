...
async function loadYaml(lines: readonly string[]): Promise<Context> {
  root = await mkdtemp(join(tmpdir(), 'monolith-token-meter-loader-'))
  ...
  const modules = new Map<string, unknown>([
    ...
    ['@monolith/token-meter', TokenMeter],
    ['@monolith/compaction-tool-result-pruner', ToolResultPruner],
    ['@monolith/compaction-basic', BasicCompactionEngine],
  ])
