...
import { ToolCallId , createMessage, createToolResultMessage } from '@monolith/llm'
import type { ContentBlock } from '@monolith/llm'
import SessionStore, {
  Session,
  SessionId,
} from '@monolith/session'
import type { SurfaceEvent } from '@monolith/session'
...
import ToolResultPruner, {
  ...
  PRUNE_MARKER,
  resolveConfig,
} from '@monolith/compaction-tool-result-pruner'
import type { ToolResultPruneConfig } from '@monolith/compaction-tool-result-pruner'
