 ...
 *
 * @module @monolith/compaction-tool-result-pruner
 */

import { Context, Service } from '@monolith/cordis'
import z from '@monolith/schemastery'
import { freezeMessage } from '@monolith/llm'
import type { ContentBlock } from '@monolith/llm'
import type { Session, SessionEvent, SessionSeq, ToolResultMessage } from '@monolith/session'
