...
import * as commandCompact from '@monolith/command-compact'
import { Session, SessionId, SessionSeq } from '@monolith/session'
...
describe('command-compact real Loader composition', () => {
  it('discovers and executes /compact through the assembled command plane', async () => {
    root = await mkdtemp(join(tmpdir(), 'monolith-command-compact-loader-'))
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@monolith/command-compact', commandCompact],
    ])
