 ...
 *
 * The seam itself lives in `@monolith/compaction`, which re-exports these
 ...
 * `monolith-commands/brand` shape.
 *
 * @module @monolith/compaction/checkpoint
 */

import type { MessageSource } from '@monolith/llm/message'
