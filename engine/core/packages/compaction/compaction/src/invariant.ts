/** Package-owned compaction log-stream invariants. @module @monolith/compaction/invariant */

import type { Context } from '@monolith/cordis'
import { isReplacementSurfaceEvent, SessionSeq } from '@monolith/session'
import type { Session, SessionEvent } from '@monolith/session'
import { SurfaceManager } from '@monolith/session/surface'
import type { InvariantFailure, InvariantInstaller } from '@monolith/invariants'
import type { CompactionId } from './brand.ts'
import { isCompactCheckpointSource } from './checkpoint.ts'
import type { CompactionCheckpointSource } from './checkpoint.ts'
import type {} from './types.ts'

const PACKAGE_NAME = '@monolith/compaction'
