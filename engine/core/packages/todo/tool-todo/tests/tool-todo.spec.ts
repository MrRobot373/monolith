...
import { Session, SessionId, SessionLogOffset } from '@monolith/session'
import type { TodoItem } from '@monolith/tool-todo'
...
/**
 * Drives the REAL plugin body: mounts `monolith-tool-todo` on a real `ToolRuntime`
