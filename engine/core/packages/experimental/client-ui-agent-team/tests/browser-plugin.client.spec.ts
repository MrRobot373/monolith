...
import type { TeamMemberView as TeamRosterMember, TeamTaskId } from '@monolith/experimental-agent-team/client'
import type {} from '@monolith/experimental-agent-team/remote'
import { RemoteError } from '@monolith/client-test-runtime'
import type { TypertRemoteContribution } from '@monolith/typert-protocol'
...
const REMOTE: TypertRemoteContribution = {
  package: '@monolith/experimental-agent-team',
  descriptors: [],
}
