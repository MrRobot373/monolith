...
import { runShellCommand } from '@monolith/experimental-webworker-runtime/src/shell/interpret.ts'
import { filesystemError } from '@monolith/experimental-webworker-runtime/src/shell/fs-access.ts'
import type {
  ShellDirent, ShellFileSystem, ShellRunOutcome, ShellStats,
} from '@monolith/experimental-webworker-runtime/src/shell/types.ts'
