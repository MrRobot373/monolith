...
check('WRAPPER_PARAMS is the frozen 7-parameter shape', [...WRAPPER_PARAMS], [
  'exports', 'require', 'module', '__filename', '__dirname', '__monolith$meta', '__als',
])
...

{
  ...
  contains('import.meta becomes the wrapper parameter', code, '__monolith$meta')
...

{
  ...
  contains('dynamic import becomes the helper call', code, '__monolith$dynImport')
...

{
  ...
  contains('trap 1: dynamic import in a CommonJS file is still rewritten', code, '__monolith$dynImport')
...

{
  ...
  const code = transformModule(source, 'probe.js')
  lacks('trap 6: a method named import is not rewritten', code, '__monolith$dynImport')
...

{
  ...
  lacks('trap 8: new.target is not replaced by the meta parameter', code, '__monolith$meta')
