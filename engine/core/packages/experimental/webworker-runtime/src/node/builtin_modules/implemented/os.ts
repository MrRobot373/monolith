 ...
 * during construction.
 */
import { MONOLITH_HOME, MONOLITH_TMP } from '../../../storage/paths.ts'
...
/**
 * Home directory.
 * @returns `$MONOLITH_HOME` inside the VFS.
 */
export function homedir(): string {
  return MONOLITH_HOME
}
