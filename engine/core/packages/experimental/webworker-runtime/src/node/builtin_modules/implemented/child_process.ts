 ...
 * @module @monolith/experimental-webworker-runtime/src/node/builtin_modules/implemented/child_process
 */
...
import { MONOLITH_ROOT } from '../../../storage/paths.ts'
...
export function spawn(
  ...
  queueMicrotask(() => {
    void (async () => {
      const cwd = options.cwd ?? MONOLITH_ROOT
