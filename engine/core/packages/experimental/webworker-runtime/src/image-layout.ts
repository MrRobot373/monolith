...
export const DEFAULT_ROOT = '/monolith'
...
/** Home directory under the root; the process shim's `MONOLITH_HOME`/`HOME` default. */
 ...
 */
export const LOWERING_VERSION = 'monolith-worker-transform/1'
