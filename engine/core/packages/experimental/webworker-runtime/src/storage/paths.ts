...
export const MONOLITH_ROOT = '/monolith'

/** `$MONOLITH_HOME`: durable-state directory inside the image. */
export const MONOLITH_HOME = `${MONOLITH_ROOT}/home`

/** Flat, symlink-free package tree resolved by the worker module loader. */
export const MONOLITH_NODE_MODULES = `${MONOLITH_ROOT}/node_modules`

/** Directory holding the composed cordis.yml and the agent-preset tree. */
export const MONOLITH_CONFIG = `${MONOLITH_ROOT}/config`

/** Default (empty) workspace directory. */
export const MONOLITH_WORKSPACE = `${MONOLITH_ROOT}/workspace`

/** Temporary directory reported by `os.tmpdir()`. */
export const MONOLITH_TMP = `${MONOLITH_ROOT}/tmp`
