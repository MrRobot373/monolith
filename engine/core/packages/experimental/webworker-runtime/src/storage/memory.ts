 ...
 * @module @monolith/experimental-webworker-runtime/src/storage/memory
 */
...
// stored value — the round-trip consumers like monolith-credentials-local's
 ...
 */
export function loadVfsImage(image: Uint8Array, root = '/monolith', vfs = new MemoryVfs()): MemoryVfs {
