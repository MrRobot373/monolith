...
- Every package here uses the `@monolith/experimental-*` npm prefix, sets `private: true`, and omits `publishConfig`; the workspace constraints gate enforces these declarations and the monolith release family excludes this directory.
