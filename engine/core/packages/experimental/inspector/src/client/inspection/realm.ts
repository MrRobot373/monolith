...
const CLIENT_SOURCE_STORAGE_KEY = 'monolith.experimental-inspector.client-source-id.v0'
const CLIENT_SOURCE_LOCK_PREFIX = 'monolith.experimental-inspector.client-source:'
