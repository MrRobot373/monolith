    ...
    switch (method) {
      ...
      case 'Network.getResponseBody': {
        ...
        return {
          ...
          base64Encoded: true,
          monolithInspectorTruncated: body.truncated,
          ...(body.captureError === undefined ? {} : { monolithInspectorCaptureError: body.captureError }),
        }
      }
    ...
    switch (event.type) {
      ...
      case 'response-received': {
        ...
        session.sendEvent('Network.responseReceived', {
          ...
          loaderId: 'monolith-inspector-loader',
          frameId: 'monolith-inspector-host-frame',
          timestamp,
          type: resourceType,
          response: {
            url: event.url,
      ...
      case 'request-finished':
        ...
        session.sendEvent('Network.loadingFinished', {
          ...
          monolithInspectorTruncated: event.truncated,
        })
