...
# @monolith/experimental-inspector

## Summary

Use this experimental inspector to inspect one running monolith Host and its browser Clients in Chrome DevTools. It exposes Host and Client Console contexts, Host Sources and debugging, captured Host fetches, and a shared Cordis tree while keeping all CDP state in a Worker.
...
The generated [configuration catalog](../../../docs/config-catalog.md#monolith-experimental-inspector) is the exhaustive source for accepted fields and their declarations.
...
import type { InspectorJsonValue } from '@monolith/experimental-inspector'
