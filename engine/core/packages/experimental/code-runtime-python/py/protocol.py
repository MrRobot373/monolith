"""Wire protocol vocabulary for the Python side of monolith-code-runtime-python.
...
def log_truncation_marker(max_bytes: int) -> str:
    ...
    return f"[monolith-code-runtime-python] log capture truncated at {max_bytes} bytes"
