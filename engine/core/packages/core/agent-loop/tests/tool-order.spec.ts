...
import SessionStore, { SessionId, foldRequestHeader } from '@monolith/session'
import SystemPrompt, { TOOL_ORDER_REST } from '@monolith/system-prompt'
import type { Config as SystemPromptConfig } from '@monolith/system-prompt'
