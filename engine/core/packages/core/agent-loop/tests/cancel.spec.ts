 ...
 * @module monolith-agent-loop/tests/cancel
 */
...
import ToolRuntime, { defineContentToolFixture, TOOL_ABORTED_BEFORE_DISPATCH } from '@monolith/tools'
...
describe('Agent.cancel()', () => {
  ...
  it('cancel during error recovery does not finalize the failed stream', async () => {
    ...
    // monolith-llm-retry opens when its backoff waits after appending llm/retry.
