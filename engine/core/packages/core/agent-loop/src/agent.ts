 ...
 * @module monolith-agent-loop/agent
 */
...
import { Inbox, agentEvents, assembleContextFor } from '@monolith/agent'
import type { GenerateOptions, LlmCallConfig, Message, PreparedLlmCall } from '@monolith/llm'
import {
  BlockAssembler,
  LlmError,
...
import { deepFreeze } from '@monolith/util-values'
import type { Scope } from '@monolith/scope'
import { createScope } from '@monolith/scope'
import type { EpochHeader, RequestContext, Session, SessionId, SessionSeq, TurnEndReason, UserMessage } from '@monolith/session'
import { canonicalHeader, headerEquals } from '@monolith/session'
import { joinContextSections, renderContextSections, renderPrompt } from '@monolith/system-prompt'
import type { PromptAssembly } from '@monolith/system-prompt'
