 ...
 * @module @monolith/agent-loop/invariant
 */

import type { Context } from '@monolith/cordis'
import { isAgentLoopRequest, type GenerateOptions } from '@monolith/llm'
import type { InvariantFailure, InvariantInstaller } from '@monolith/invariants'
import { foldRequestHeader } from '@monolith/session'

const PACKAGE_NAME = '@monolith/agent-loop'
