 ...
 * @module @monolith/session/repair
 */

import { brandString } from '@monolith/brand'
import type { MessageId, ToolCallId, ToolResultMessage } from '@monolith/llm'
      ...
      content: [{
        ...
        content: [{
          ...
          text: started
            ...
            : 'The tool call was interrupted before MONOLITH recorded it as started. Retry it if it is still needed.',
        }],
      }],
    })
    closers.push({
