 ...
 *
 * @module @monolith/session
 */

import { Context, Service } from '@monolith/cordis'
import { isAbsolute } from 'node:path'
import { brandString } from '@monolith/brand'
import { deepFreeze, snapshotJsonValue } from '@monolith/util-values'
import { scopeOf, scopeTarget } from '@monolith/scope'
import type { Scoped } from '@monolith/scope'
import type { Message } from '@monolith/llm'
import { SESSION_FORMAT_VERSION, SessionLogOffset, SessionSeq } from './types.ts'
import type { TypertLookup } from '@monolith/typert-protocol'
...
export type { AssistantMessage, ToolResultMessage, UserMessage } from '@monolith/llm'
  ...
  constructor(ctx: Context) {
    ...
    ctx.inject(['typert'], (typeCtx) => {
      typeCtx.typert.lookups.register('session', {
        parameter: 'session',
        wire: 'sessionId',
        hostTypeSymbol: '@monolith/session#Session',
