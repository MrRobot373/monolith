 ...
 * companion beside `@monolith/invariants` to enable the checks.
 *
 * @module @monolith/session/invariant
 */
...
import type { Session, SessionEvent, SessionSeqCursor } from '@monolith/session'
import { assertNever } from '@monolith/util-values'
import { TOOL_NOT_STARTED } from './repair.ts'

const PACKAGE_NAME = '@monolith/session'
