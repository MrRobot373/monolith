...
import LlmRuntime, { createUserMessage, ToolCallId, HarnessError, type ContentBlock  } from '@monolith/llm'
...
import ApprovalService, { type ApprovalOutcome, type ApprovalRequest } from '@monolith/user-approval'
import ToolRuntime, {
