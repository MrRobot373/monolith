/** Package-owned scoped-dispatch invariants. @module @monolith/scope/invariant */

import type { Context } from '@monolith/cordis'
import type { InvariantInstaller } from '@monolith/invariants'
import { carrierKeyOf, isScopeCarrier } from '@monolith/scope'
import { scopedSubjectResolverFor } from './scoped-events.generated.ts'

const PACKAGE_NAME = '@monolith/scope'
