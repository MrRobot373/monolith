 ...
 * ([`monolith-code-runtime-worker-thread`](../../code-runtime/code-runtime-worker/README.md)).
 ...
 * @module @monolith/agent-tool-presentation
 */

import type { Context } from '@monolith/cordis'
import z from '@monolith/schemastery'
import type { ToolPresentationMode } from '@monolith/tools'
...
export function apply(ctx: Context, config: Config): void {
  ...
  // what `monolith-agent-presets` reports as an unusable row, naming this id.
