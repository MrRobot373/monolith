...
import { createScope, scopeOf } from '@monolith/scope'
import type { Scope, ScopeKey } from '@monolith/scope'
import SystemPrompt, { TOOL_ORDER_REST, renderContextSnapshot, renderPrompt } from '@monolith/system-prompt'
import type { Config, PromptAssembly } from '@monolith/system-prompt'
