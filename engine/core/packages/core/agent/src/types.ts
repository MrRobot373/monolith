 ...
 *
 * @module @monolith/agent/types
 */

import type { UserMessage } from '@monolith/llm/types'
import type { OptionalSessionSeq, SessionId, SessionSeq } from '@monolith/session/types'
import type { TypertContext, TypertLookup } from '@monolith/typert-protocol'
 ...
 *
 * Reader contract: the key is registered by `monolith-agent-loop` and absent
