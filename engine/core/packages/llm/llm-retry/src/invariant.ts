/** Package-owned durable retry-event invariants. @module @monolith/llm-retry/invariant */

import type { Context } from '@monolith/cordis'
import type { Session, SessionEvent } from '@monolith/session'
import type { LlmFailure } from '@monolith/llm'
...
const PACKAGE_NAME = '@monolith/llm-retry'
