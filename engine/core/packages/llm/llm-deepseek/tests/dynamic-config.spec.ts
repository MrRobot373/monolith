...
import LlmRuntime, { createUserMessage, INVALID_CREDENTIAL_CODE } from '@monolith/llm'
...
async function home(): Promise<string> {
  const dir = await mkdtemp(join(tmpdir(), 'monolith-llm-dynamic-'))
