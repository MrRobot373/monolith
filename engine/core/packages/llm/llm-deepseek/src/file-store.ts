/** DeepSeek Files API upload reuse, invalidation, and quota recovery. @module monolith-llm-deepseek/file-store */

import type { RequestImageAttachment } from '@monolith/attachment'
...
const OWNED_FILE_PREFIX = 'monolith-'
