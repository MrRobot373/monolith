/** OpenAI-compatible DeepSeek Files API transport. @module monolith-llm-deepseek/files-api */

import { attributionHeaders, LlmError } from '@monolith/llm'
import type { ImageMediaType } from '@monolith/attachment'
