 ...
 *
 * @module monolith-llm-pi-ai/discovery
 */

import { INVALID_CREDENTIAL_CODE, LlmError, normalizeApiKey } from '@monolith/llm'
import type { LlmDiscoveredModel, LlmModelDiscoveryOperation } from '@monolith/llm'
import { attributionHeaders } from '@monolith/llm'
 ...
 * on the length the server claims — the same two-stage shape `monolith-web-fetch`
