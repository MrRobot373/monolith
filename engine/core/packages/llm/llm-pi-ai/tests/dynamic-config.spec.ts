...
import LlmRuntime, { LlmAdapter } from '@monolith/llm'
...
import AuthorizationService from '@monolith/authorization'
...
async function home(): Promise<string> {
  const dir = await mkdtemp(join(tmpdir(), 'monolith-pi-dynamic-'))
