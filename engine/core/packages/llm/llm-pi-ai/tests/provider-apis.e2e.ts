...
import LlmRuntime, { createUserMessage, ToolCallId } from '@monolith/llm'
...
const openAIBaseURL = process.env.MONOLITH_PI_AI_OPENAI_BASE_URL
...
const anthropicBaseURL = process.env.MONOLITH_PI_AI_ANTHROPIC_BASE_URL

const providerCases: ProviderCase[] = [
  {
    provider: 'openai',
    api: 'openai-responses',
    model: process.env.MONOLITH_PI_AI_OPENAI_MODEL ?? 'gpt-5.5',
    ...azureOpenAIKey
  ...
  },
  {
    ...
    model: process.env.MONOLITH_PI_AI_ANTHROPIC_MODEL ?? 'claude-opus-4-8',
