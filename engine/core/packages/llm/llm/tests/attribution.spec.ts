...
import { APP_IDENTITY, attributionHeaders, userAgent } from '@monolith/llm'
import type { AppIdentity } from '@monolith/llm'
...
describe('userAgent', () => {
  it('renders product/version with the +url comment', () => {
    expect(userAgent()).toBe(
      `monolith/${manifest.version} (+https://github.com/MrRobot373/monolith)`,
    )
  })
