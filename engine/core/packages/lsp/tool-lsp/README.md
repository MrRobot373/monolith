...
| `timeoutMs` | `60000` | Tool-call timeout budget enforced by `monolith-tool-call-timeout-policy`; covers the complete queued open/query/close lifecycle and is not model-configurable |

The generated [configuration catalog](../../../docs/config-catalog.md#monolith-tool-lsp) is the exhaustive source for every accepted field.
...
- [monolith-lsp](../lsp/README.md) — the seam this tool queries.
- [monolith-lsp-stdio](../lsp-stdio/README.md) — the stdio provider that answers these queries.
...
The model sees the generated [`lsp` schema](../../../docs/tool-catalog.md#monolith-tool-lsp).
