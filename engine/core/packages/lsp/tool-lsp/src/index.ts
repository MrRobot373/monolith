 ...
 * `monolith-tool-call-timeout-policy` to enforce. It runtime-injects only `tools`, `lsp`, and `systemPrompt` and
 * imports no provider.
 *
 * Namespace plugin (named exports, no default export).
 * @module @monolith/tool-lsp
 */

import type { Context } from '@monolith/cordis'
import z from '@monolith/schemastery'
import { defineTool } from '@monolith/tools'
import { LspError } from '@monolith/lsp'
import type {} from '@monolith/lsp'
