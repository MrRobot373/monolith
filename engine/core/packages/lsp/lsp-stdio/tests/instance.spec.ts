...
import { LspInstance, readHostSource } from '@monolith/lsp-stdio'
import { encodeMessage } from '@monolith/lsp-stdio'
import type { ConnectionWriter } from '@monolith/lsp-stdio/src/connection.ts'
import type { InstanceSpec } from '@monolith/lsp-stdio/src/instance.ts'
import type { LspProviderQuery, LspQueryResult } from '@monolith/lsp'
