...
import type { EntryInfo, Sandbox } from '@monolith/e2b'

const VERSION_METADATA_KEY = 'monolith-version'
...
export class E2BFileSystem extends FileSystem {
  ...
  private async writeAtomic(
    ...
    const stagingDirectory = posix.join(posix.dirname(targetPath), `.monolith-${randomUUID()}.tmp`)
