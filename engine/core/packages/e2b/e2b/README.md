...
The generated [configuration catalog](../../../docs/config-catalog.md#monolith-e2b) is the exhaustive source for every accepted field and its JSDoc.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#monolith-e2b) — every accepted config field and its source declaration.
