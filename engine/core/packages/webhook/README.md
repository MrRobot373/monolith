---
description: "Package map for verified external events, programmatic rules, and fire-and-forget MONOLITH Session creation."
kind: "package-group"
---

# webhook/ — verified external events to MONOLITH Sessions
