...
import { Win32Error } from '@monolith/win32-process'
import { ERROR_BROKEN_PIPE } from '@monolith/win32-process/src/abi.ts'
import { PROCESS_INFORMATION } from '@monolith/win32-process/src/ffi.ts'
...
function scratch(): string {
  const dir = mkdtempSync(join(tmpdir(), 'monolith-acl-index-'))
