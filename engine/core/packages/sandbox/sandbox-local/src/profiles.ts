 ...
 *
 * @module @monolith/sandbox-local/profiles
 */

import { grantArgs as landlockGrantArgs } from '@monolith/node-addon-landlock-run'
 ...
 * (`@monolith/fs-sandbox`) can never drift apart.
