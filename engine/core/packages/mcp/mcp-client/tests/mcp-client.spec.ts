...
import AttachmentStore, { AttachmentError, AttachmentId } from '@monolith/attachment'
...
import type { PostToolDecision } from '@monolith/tools'
import { publicToolName, syncTools, type ToolBridgeOptions } from '@monolith/mcp-client/src/tools.ts'
import { createTransport } from '@monolith/mcp-client/src/transport.ts'
import type { Config } from '@monolith/mcp-client'
