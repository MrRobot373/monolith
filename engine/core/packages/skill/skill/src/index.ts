 ...
 * Concrete
 * providers such as `@monolith/skill-filesystem` decide where skills come
 ...
 *
 * @module @monolith/skill
 */

import { Context, Service } from '@monolith/cordis'
import type {} from '@monolith/llm'
import { assertNever } from '@monolith/util-values'
import { NamedEntries, ScopedLayers, scopeChainOf, scopeOf } from '@monolith/scope'
...
export type SkillSource = 'project-monolith' | 'project-agents' | 'runtime' | 'user-monolith' | 'user-agents' | 'custom' | 'bundled' | (string & {})
