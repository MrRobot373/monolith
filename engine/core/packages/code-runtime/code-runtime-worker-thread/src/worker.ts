 ...
 * @module @monolith/code-runtime-worker-thread/src/worker
 */
...
if (!parentPort) throw new Error('monolith-code-runtime-worker-thread: worker entry loaded outside a worker thread')
