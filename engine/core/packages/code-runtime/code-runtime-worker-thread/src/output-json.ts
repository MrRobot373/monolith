/** JSON string-prefix accounting for the outer-output ledger. @module @monolith/code-runtime-worker-thread/output-json */

import type { CodeJsonValue } from '@monolith/code-runtime'
