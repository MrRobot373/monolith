...
import type { Config } from '@monolith/code-runtime-worker-thread'
import type { CodeBindingFunction, CodeBindingNamespace, CodeRunResult } from '@monolith/code-runtime'
...
describe('WorkerThreadCodeRuntime — seam misuse and lifecycle', () => {
  ...
  it('rejects malformed or colliding binding error-class declarations', async () => {
    ...
    await expect(runtime.run({ program: 'return 1', bindings: [{ global: '__monolith_main__', functions: {} }] }))
