...
import * as SessionLogDownload from '@monolith/session-log-export'
...
describe('session-log-download real Loader composition', () => {
  it('discovers and executes /export through the assembled command plane', async () => {
    root = await mkdtemp(join(tmpdir(), 'monolith-session-export-loader-'))
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@monolith/session-log-export', SessionLogDownload],
    ])
