 ...
 *
 * @module @monolith/tool-session-query/workspace-access
 */
...
import type { TurnBoundaryProjection } from '@monolith/agent'
import type {
  SessionLineageNode,
  SessionRecord,
} from '@monolith/session-query'
import type { ToolRunContext } from '@monolith/tools'
