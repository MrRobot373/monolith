...
import type { Session, SessionEvent, SessionHeader, SessionId as SessionIdType } from '@monolith/session'
...
import { type SessionQueryErrorCode } from '@monolith/session-query'
