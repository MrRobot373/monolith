...
The generated [configuration catalog](../../../docs/config-catalog.md#monolith-session-query-sqlite) is the exhaustive source for every accepted field and its JSDoc.
...
- [monolith-session-query](../session-query/README.md) — the service definition: exact reads, filters, and traces this backend inherits.
- [monolith-tool-session-query](../tool-session-query/README.md) — the model-facing consumer that calls these search methods.
