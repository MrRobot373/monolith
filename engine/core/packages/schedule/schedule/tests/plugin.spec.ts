...
import { SessionLogOffset, SessionId } from '@monolith/session'
...
import type { SessionAccess, SessionHandle, SessionPersistenceSnapshot } from '@monolith/session-persistence'
