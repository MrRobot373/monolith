 ...
 *
 * @module @monolith/tool-bash/render
 */

import type { ShellProcessRead, ShellRunResult, ShellSandboxInfo, CollectedOutput } from '@monolith/shell'
import type { SandboxMode } from '@monolith/sandbox'
import { escalationHintMarker, sandboxDenialMarker } from '@monolith/sandbox'
 ...
 * rendering story, owned by `@monolith/shell` so `monolith-tool-pwsh` reuses
 ...
 */
export { parseExitStatus, type ParsedExitStatus } from '@monolith/shell'
