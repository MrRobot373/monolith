 ...
 * to `@monolith/jobs`; this seam exposes only process handles. The
 ...
 * root.
 * @module monolith-shell/types
 */

import type { SandboxEnforcement, SandboxExecutionPolicy, SandboxMode } from '@monolith/sandbox'
import type { CollectedOutput, MonolithEnvironment } from '@monolith/subprocess'

export { MONOLITH_ENV_PREFIX } from '@monolith/subprocess'
export type { CollectedOutput, MonolithEnvironment, MonolithEnvironmentKey } from '@monolith/subprocess'
