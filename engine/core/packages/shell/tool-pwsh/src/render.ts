 ...
 * `monolith-tool-bash`'s renderer: stdout, a marked stderr section, sandbox
 ...
 * results.
 *
 * @module @monolith/tool-pwsh/render
 */

import type { ShellProcessRead, ShellSandboxInfo, CollectedOutput } from '@monolith/shell'
import type { SandboxMode } from '@monolith/sandbox'
import { escalationHintMarker, sandboxDenialMarker } from '@monolith/sandbox'

/* jscpd:ignore-start -- deliberate twin of monolith-tool-bash/render.ts (Agent Note). */
