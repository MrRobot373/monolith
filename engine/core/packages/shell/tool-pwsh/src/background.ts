 ...
 * twin of `monolith-tool-bash`'s background adaptation.
 *
 * @module @monolith/tool-pwsh/background
 */

import type { ShellProcess } from '@monolith/shell'

/* jscpd:ignore-start -- deliberate twin of monolith-tool-bash/background.ts (Agent Note). */
