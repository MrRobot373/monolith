 ...
 * `@monolith/bash-sandbox`. It wraps the exact local pwsh argv through
...
import { SandboxUnavailableError } from '@monolith/sandbox'
import type {
  ConfinedArgv,
  ConfinedSandboxMode,
  RunnerFailureRule,
 ...
 * on `ctx.sandboxPolicy` (`@monolith/sandbox-policy`), which resolves
