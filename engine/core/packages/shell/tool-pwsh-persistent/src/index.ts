 ...
 * @module @monolith/tool-pwsh-persistent
 */
...
import type { TerminalReadResult, TerminalSendResult, TerminalSessionId } from '@monolith/terminal'
...
const SHELL_PROMPT = '__MONOLITH_PERSISTENT_PWSH_PROMPT__ '
...
function markers(): CommandMarkers {
  ...
  return {
    start: `__MONOLITH_PERSISTENT_PWSH_START_${nonce}__`,
    end: `__MONOLITH_PERSISTENT_PWSH_END_${nonce}:`,
  }
}
