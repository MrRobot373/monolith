...
const INDIRECTION_PREFIX = '--monolith-scrollbar-'
...
const ELEVATED_REBIND = new Map([
  ['--monolith-scrollbar-thumb', '--dsw-alias-scrollbar-bg-l2'],
  ['--monolith-scrollbar-thumb-hover', '--dsw-alias-scrollbar-hover-l2'],
...
describe('scrollbar.css width variable', () => {
  ...
  it('every reader of the width variable outside ui-theme references a defined variable', () => {
    ...
    // (`right: var(--monolith-scrollbar-width)`); a rename in scrollbar.css without
