...
import { apply, inject, SETTINGS_NS } from '@monolith/client-ui-theme/client'
import type { AppearanceRowInjected, FontSizeRowInjected, ThemeRuntime } from '@monolith/client-ui-theme/client'
