...
import type { BoundActions } from '@monolith/client-ui-slots'
// Type-only: the ctx.settingsScope Context merge. Cross-plugin collaboration
// goes through the service, never a value import (client bundle purity gate).
import type { SettingsScope } from '@monolith/client-ui-settings/client'
...
function bootstrapFontSize(): number {
  ...
  const raw = document.body.style.getPropertyValue('--monolith-content-font-size')
