---
description: "Theme and content-font-size settings for the monolith web client: --dsw-* token stylesheets, ThemeRuntime state, General settings rows, and the pre-plugin bootstrap."
...
- [ui-conversation](../ui-conversation/README.md) — a consumer of `--monolith-scrollbar-width` for the composer seat.
