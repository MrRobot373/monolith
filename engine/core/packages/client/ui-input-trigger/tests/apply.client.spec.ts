...
import { apply, inject, InputTriggerService } from '@monolith/client-ui-input-trigger/client'
import type { MenuViewInjected } from '@monolith/client-ui-input-trigger/client'
