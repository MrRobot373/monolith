...
import { InputTriggerService } from '@monolith/client-ui-input-trigger/client'
import type {
...
describe('scenario A: menu-pick /goal, type args, enter submits', () => {
  it('runs the whole claim chain through the real pipeline', async () => {
    ...
    expect(b.textarea.style.getPropertyValue('--monolith-composer-hint')).toBe(JSON.stringify('输入目标，智能体将持续执行'))
