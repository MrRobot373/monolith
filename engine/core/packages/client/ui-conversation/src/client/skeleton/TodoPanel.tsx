...
import type { PropsLocale, PropsRuntime } from '@monolith/client-ui-slots'
...
import { IconChecklistOutline14, IconChevronDownOutline14, IconChevronUpOutline14 } from '@monolith/client-ui-primitives'
...
/** Local exhaustiveness helper — client packages do not depend on `monolith-llm`. */
