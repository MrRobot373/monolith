...
import type {} from '@monolith/goal/client'
...
import type { Translate } from '@monolith/client-ui-slots'
        ...
        <div ref={scrollRef} className={css.scroll} data-input-scroll>
          <div className={css.grow}>
            <ComposerContentEditable
              ...
              style={hint === null ? undefined : { '--monolith-composer-hint': JSON.stringify(hint) } as CSSProperties}
            />
            {empty && !claimActive && (
