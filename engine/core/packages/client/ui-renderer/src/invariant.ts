/**
 * Package-owned invariant companion for `@monolith/client-ui-renderer`.
 * @module @monolith/client-ui-renderer/invariant
 */
...
import type { SlotMap } from '@monolith/client-ui-slots'
import type { InvariantInstaller } from '@monolith/invariants'

const PACKAGE_NAME = '@monolith/client-ui-renderer'
