...
import * as Cordis from '@monolith/cordis'
import * as ClientStore from '@monolith/client-store'
import * as UiSlots from '@monolith/client-ui-slots'
import * as UiPrimitives from '@monolith/client-ui-primitives'
...
export function getStaticModules(): Record<string, unknown> {
  ...
  return {
    ...
    '@monolith/cordis': Cordis,
    '@monolith/client-store': ClientStore,
    '@monolith/client-ui-slots': UiSlots,
    '@monolith/client-ui-primitives': UiPrimitives,
