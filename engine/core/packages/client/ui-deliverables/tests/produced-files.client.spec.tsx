...
import { apply as applyLocale, inject as localeInject } from '@monolith/client-locale/client'
import type { ChatFileMentions, TurnTailOwnerProps } from '@monolith/client-ui-chat/client'
import { makeTranslate, RemoteError, stubSettingsScope } from '@monolith/client-test-runtime'
