...
describe('SidebarRoot shell', () => {
  ...
  it('renders generic brand fallbacks when no package fills the slots', () => {
    vi.stubEnv('MONOLITH_CLIENT_COMMIT_HASH', '0123456')
    ...
    expect(screen.getByText('MONOLITH Local Build')).toBeTruthy()
    expect(screen.getByText('1.2.3-rc.4-0123456-dirty')).toBeTruthy()
    expect(container.querySelector('svg')).not.toBeNull()
  })

  it.each([
    [{ MONOLITH_CLIENT_VERSION: '1.2.3' }, '1.2.3'],
    [{ MONOLITH_CLIENT_COMMIT_HASH: 'abcdef0', MONOLITH_CLIENT_VERSION: '1.2.3' }, '1.2.3-abcdef0'],
