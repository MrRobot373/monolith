...
import { SlotTestRuntime, usePinnedBrowserLanguages } from '@monolith/client-test-runtime'
...
import { apply, inject } from '@monolith/client-ui-sidebar/client'
...
beforeEach(() => {
  vi.stubEnv('MONOLITH_CLIENT_COMMIT_HASH', 'abc1234')
  vi.stubEnv('MONOLITH_CLIENT_GIT_DIRTY', 'true')
  vi.stubEnv('MONOLITH_CLIENT_VERSION', '1.2.3-rc.4')
})
