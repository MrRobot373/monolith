...
const SNAPSHOT = {
  entries: [
    ...
    { entryId: '8a1b2c3d', moduleName: '@monolith/cordis-plugin-hmr', enabled: true, fiberPhase: 'active' },
    { entryId: 'unobserved', moduleName: '@fixture/unobserved-name', enabled: true, fiberPhase: null },
    { entryId: 'bash-host', moduleName: '@monolith/tool-bash', enabled: false, fiberPhase: null },
    { entryId: 'fs-host', moduleName: '@monolith/tool-fs', enabled: false, fiberPhase: null },
  ...
  agentPresets: [
    {
      ...
      isDefault: true,
      rows: [
        { entryId: 'bash', moduleName: '@monolith/tool-bash', enabled: true, fiberPhase: 'active' },
        { entryId: 'fs', moduleName: '@monolith/tool-fs', enabled: true, fiberPhase: null },
        {
          entryId: 'pwsh',
    ...
    },
    {
      ...
      isDefault: false,
      rows: [
        { entryId: 'bash', moduleName: '@monolith/tool-bash', enabled: true, fiberPhase: null },
        { entryId: 'bash-fork', moduleName: '@monolith/tool-bash', enabled: true, fiberPhase: null },
        { entryId: 'fs', moduleName: '@monolith/tool-fs', enabled: 'conditional', fiberPhase: null },
      ],
    },
...
describe('PluginInventorySettingsTab', () => {
  ...
  it('renders a rosterless deployment as one expanded global list', async () => {
    const view = await renderReady({
      entries: [
        { entryId: 'hmr', moduleName: '@monolith/cordis-plugin-hmr', enabled: true, fiberPhase: 'active' },
