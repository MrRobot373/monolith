...
// The resolution itself is the shared fold in `monolith-agent-presets/display`,
...
export { presetDisplayText } from '@monolith/agent-presets/display'
export type { PresetDisplaySource, PresetDisplayText } from '@monolith/agent-presets/display'
