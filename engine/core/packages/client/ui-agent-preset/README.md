...
# @monolith/client-ui-agent-preset
...
- [monolith-agent-presets](../../preset/agent-presets/README.md) — the host roster and composition the surfaces read and manage.
