...
import { AppFrame } from '@monolith/client-ui-layout/src/client/AppFrame.tsx'
import type { AppFrameProps } from '@monolith/client-ui-layout/src/client/AppFrame.tsx'
import { SIDEBAR_COLLAPSED } from '@monolith/client-ui-layout/src/client/columns.ts'
import { createLayoutStore } from '@monolith/client-ui-layout/src/client/stores.ts'
...
function mountFrame() {
  ...
  const element = () => (
    <AppFrame
      ...
      t={key => key === 'brand.localBuild' ? 'MONOLITH Local Build' : key}
    />
  )
...
describe('AppFrame', () => {
  ...
  it('projects the selected durable Session title', () => {
    vi.stubEnv('MONOLITH_CLIENT_TITLE', 'Product')
