...
} from '@monolith/tool-workflow/types'
import type { WorkflowAgentOutcome, WorkflowStopReason } from '@monolith/workflow/types'
...
declare module '@monolith/client-ui-chat/client' {
