...
# @monolith/client-ui-model-selection
...
- [monolith-agent-default-model](../../core/agent-default-model/README.md) — the default-model service for sessions that never choose.
