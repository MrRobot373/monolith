...
import type { SettingsPathOpView } from '@monolith/api-remotes/client'
import { RemoteError, stubSettingsScope, type StubSettingsScope } from '@monolith/client-test-runtime'
...
} from '@monolith/client-ui-settings/src/client/settings-mirror.ts'
