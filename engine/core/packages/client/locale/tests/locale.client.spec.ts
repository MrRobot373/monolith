...
import { stubSettingsScope, type StubSettingsScope } from '@monolith/client-test-runtime'
import type { LocaleSettings, LocaleSnapshot } from '@monolith/client-locale/client'
import { FALLBACK_LOCALE, LocaleRuntime } from '@monolith/client-locale/client'
 ...
 * `usePinnedBrowserLanguages` (monolith-client-test-runtime): they need the shapes
...
describe('LocaleRuntime', () => {
  ...
  it('persists an explicit pick of the provisional locale, so a shared MONOLITH home agrees', () => {
