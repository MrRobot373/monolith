---
description: "Slot registry pure core for the monolith web client: SlotMap declaration merging, the single register composition API, four-share props types, store seats, and the renderer install contract."
