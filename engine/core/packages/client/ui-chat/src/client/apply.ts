...
import type { SessionBinding } from '@monolith/api-session-controller/client'
import type { BoundActions, ObservableSnapshot } from '@monolith/client-store'
import type { SessionId } from '@monolith/session/types'
import { resolveWorkspacePath } from '@monolith/util-workspace-path'
// Type-only service and declaration merges used by the apply world.
import type {} from '@monolith/client-locale/client'
import type {} from '@monolith/client-ui-conversation/client'
import type {} from '@monolith/client-ui-layout/client'
import type {} from '@monolith/client-ui-renderer/client'
import type {} from '@monolith/client-ui-session/client'
import type {} from '@monolith/client-ui-settings/client'
import type {} from '@monolith/client-ui-workspace/client'
import type {
