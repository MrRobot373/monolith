...
import type { GoalProjection } from '@monolith/goal/client'
import { LocaleRuntime } from '@monolith/client-locale/client'
import { makeTranslate, RemoteError } from '@monolith/client-test-runtime'
import type { RemoteFailure } from '@monolith/api-remotes/client'
