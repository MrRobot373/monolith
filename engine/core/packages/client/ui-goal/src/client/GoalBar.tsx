...
import type { GoalSnapshot } from '@monolith/goal/client'
import {
...
import type { PropsLocale } from '@monolith/client-ui-slots'
...
export type GoalDockProps = import('@monolith/client-ui-slots').PropsRuntime<'conversation.input.dock'> & GoalBarActions & PropsLocale<'goal'>
