/** Official MONOLITH occupants for the generic browser-brand slots. */
 ...
 * conversation hero stays on its declaring package's animated mark fallback,
 * so the official build registers nothing there.
 * @param ctx - Client root context.
 */
export function apply(ctx: ClientContext): void {
  if (process.env.MONOLITH_CLIENT_BUILD_PROFILE !== 'official') return
