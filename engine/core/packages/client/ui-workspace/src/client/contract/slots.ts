 ...
 */
import type { HostObservable, PropsHooks, PropsLocale, PropsRenderSlots, PropsRuntime, PropsStore } from '@monolith/client-ui-slots'
...
import type { SessionSearchResultItem } from '@monolith/api-session-controller/client'
import type { RemoteHostFacts } from '@monolith/api-remotes/client'
import type { WorkspaceId, WorkspaceView } from '@monolith/api-workspace-controller/client'
