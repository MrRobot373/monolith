...
import type { RemoteHostFacts } from '@monolith/api-remotes/client'
import type { ISessions } from '@monolith/api-session-controller/client'
import type { IWorkspaces, WorkspaceSnapshot } from '@monolith/api-workspace-controller/client'
import type { HostObservable, SnapshotSelectorHook } from '@monolith/client-ui-slots'
// Type-only: pulls the Controller service merges.
import type {} from '@monolith/api-session-controller/client'
import type {} from '@monolith/api-workspace-controller/client'
// Type-only: pulls the locale plugin's Context merge (ctx.locale).
import type {} from '@monolith/client-locale/client'
// Type-only: pulls the SlotRegistry service merge (ctx.slots).
import type {} from '@monolith/client-ui-renderer/client'
// Type-only: pulls the Session root standard-hook merge.
import type {} from '@monolith/client-ui-session/client'
 ...
 * to this one is NOT constrained: monolith.client.inject edges are informational
