...
import type { SessionListState } from '@monolith/api-session-controller/client'
...
import type { ToolCallOwnerProps } from '@monolith/client-ui-tool/client'
import { IconGlobeOutline14 } from '@monolith/client-ui-primitives'
import { webCardModel } from '../src/client/tool/models/web-card-model.ts'
import { createChatStore } from '@monolith/client-ui-chat/src/client/stores.ts'
import { GenericToolCard } from '../src/client/tool/toolviews/GenericToolCard.tsx'
import { DetailsPanel } from '@monolith/client-ui-chat/src/client/details/DetailsPanel.tsx'
...
import { makeTranslate } from '@monolith/client-test-runtime'
import { zh as commonZh } from '@monolith/client-locale/src/locales/zh.ts'
import { zh } from '@monolith/client-ui-conversation/src/client/locales.ts'
import { zh as chatZh } from '@monolith/client-ui-chat/src/client/locale.ts'
...
describe('web toolview registration', () => {
  it('registers one WebRow under both web_search and web_fetch', () => {
    ...
    } as unknown as import('@monolith/cordis').Context
