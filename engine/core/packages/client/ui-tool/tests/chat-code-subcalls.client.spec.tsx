...
import { en as conversationEn, NS as CONVERSATION_NS, zh as conversationZh } from '@monolith/client-ui-conversation/src/client/locales.ts'
import { apply as applyChat, inject as injectChat } from '@monolith/client-ui-chat/client'
