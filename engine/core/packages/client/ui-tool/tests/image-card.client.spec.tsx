...
import type { RunningToolCall, ToolResultNode } from '@monolith/client-ui-chat/client'
...
import type { MessageImageLoader } from '@monolith/client-ui-conversation/client'
