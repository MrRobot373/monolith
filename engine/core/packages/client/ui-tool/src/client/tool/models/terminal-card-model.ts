...
import type { TerminalBlockLabels, TerminalBlockProps } from '@monolith/client-ui-primitives'
...
function shellCall(name: string, args: Record<string, unknown>): ShellCall | null {
  ...
  if (description === undefined) {
    // Standard monolith-tool-bash and monolith-tool-pwsh schemas require `description`;
...
/**
 * Parse the marker literals owned by `@monolith/shell/render` without
