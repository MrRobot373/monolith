...
import type { AttachmentId, ImageAttachmentRef, ImageMediaType } from '@monolith/attachment'
 ...
 *  Hand-written mirror of `ImageMediaType` from monolith-attachment — the wire
