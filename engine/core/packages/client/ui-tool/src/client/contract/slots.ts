...
import type { ToolCallBlock } from '@monolith/client-ui-chat/client'
import type { MessageImageLoader, MessageImageSource } from '@monolith/client-ui-conversation/client'
