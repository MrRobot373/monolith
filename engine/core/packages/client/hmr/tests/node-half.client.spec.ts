...
import type { ClientArtifactBaseline, ClientModuleRegistry, WebBootGraph } from '@monolith/client-modules'
import type { WebRoute, WebServer } from '@monolith/host-webserver'
...
beforeEach(() => { dir = mkdtempSync(join(tmpdir(), 'monolith-hmr-')) })
