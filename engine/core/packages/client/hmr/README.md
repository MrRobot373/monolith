...
The generated [configuration catalog](../../../docs/config-catalog.md#monolith-client-hmr) is the exhaustive source for every accepted field and its JSDoc.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#monolith-client-hmr) — every accepted config field and its source declaration.
