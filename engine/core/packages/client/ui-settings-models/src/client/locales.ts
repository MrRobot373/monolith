...
export const en = {
  ...
  creating: 'Creating\u2026',
  welcomeTitle: 'Welcome to MONOLITH',
  welcomeBody: "MONOLITH runs your organisation's agents on infrastructure you control. Pick a model below to get started — cloud providers give the strongest answers, and local models keep every request on your own hardware.\n\nYou can change this selection at any time from Settings.",
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  create: '创建提供方',
  creating: '创建中\u2026',
  welcomeTitle: '欢迎使用 MONOLITH',
  welcomeBody: 'MONOLITH 在您自己掌控的基础设施上运行组织的 agent。请在下方选择一个模型：云端模型效果最好，本地模型则让所有请求都留在您自己的硬件上。\n\n您随时可以在设置中更改这一选择。',
  welcomeContinue: '继续',
