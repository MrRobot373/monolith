...
import { bindSnapshotSelector, RemoteError } from '@monolith/client-test-runtime'
import { Context } from '@monolith/cordis'
import { SettingsSchemaService } from '@monolith/client-ui-settings/src/client/schema.ts'
import { SettingsDescribeMirror } from '@monolith/client-ui-settings/src/client/settings-mirror.ts'
import { SettingsScopeController } from '@monolith/client-ui-settings/src/client/settings-scope.ts'
...
describe('WelcomeNotice', () => {
  it('uses the exact owner copy in both GUI locales', () => {
    expect(WELCOME_NOTICE_COPY.en).toEqual({
      ...
      body: "MONOLITH runs your organisation's agents on infrastructure you control. Pick a model below to get started — cloud providers give the strongest answers, and local models keep every request on your own hardware.\n\nYou can change this selection at any time from Settings.",
