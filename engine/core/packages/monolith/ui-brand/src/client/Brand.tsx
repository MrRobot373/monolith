import type { HeroBrandMarkOwnerProps } from '@monolith/client-ui-conversation/client'
import type {
  SidebarBrandMarkOwnerProps,
} from '@monolith/client-ui-sidebar/client'
 ...
 * occupies this seat: the fallback here is DeepSeek's own mark.
