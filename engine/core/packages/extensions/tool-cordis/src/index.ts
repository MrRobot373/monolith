...
} from '@monolith/cordis-host-runner'
import type { DynamicCordisReference } from '@monolith/cordis-host-runner'
...
function renderUnavailableReference(id: string): string {
  return [
    ...
    'It may have been removed, belong to another Session, or have been lost when the MONOLITH process restarted.',
