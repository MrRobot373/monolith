 ...
 * @module @monolith/cordis-host-runner/guard
 */

import { Context } from '@monolith/cordis'
import type { Plugin } from '@monolith/cordis'
import { scopeOf } from '@monolith/scope'
import { assertSupportedJsonSchema, defineTool } from '@monolith/tools'
...
function sandboxContext(ctx: Context, reportFailure: (error: Error) => void): Context {
  ...
  // (`@monolith/cordis-client-runner`, whose CTX_VERBS names this one its
