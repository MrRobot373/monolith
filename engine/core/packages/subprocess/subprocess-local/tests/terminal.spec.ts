...
import { LocalTerminalHandle } from '@monolith/subprocess-local/src/terminal.ts'
import { createProcessInspector } from '@monolith/subprocess-local/src/process-inspector.ts'
import type {
  ProcessIdentity,
  ProcessInspector,
...
import type { SubprocessTerminalSignal } from '@monolith/subprocess'
