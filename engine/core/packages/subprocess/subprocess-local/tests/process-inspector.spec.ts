...
import type { ProcessInspectorInternals } from '@monolith/subprocess-local/src/process-inspector.ts'
import { WindowsProcessInspector } from '@monolith/subprocess-local/src/windows-inspector.ts'
