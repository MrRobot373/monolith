/** Shared top-level-call post-policy selection for search result spill. @module monolith-tool-fs-search/direct-call */

import type { Context } from '@monolith/cordis'
import type { PostToolDecision, ToolDefinition, ToolExecution, ToolExecutionResult } from '@monolith/tools'
