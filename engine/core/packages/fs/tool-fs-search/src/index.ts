 ...
 * ({@link module:@monolith/tool-fs-search/glob} /
 * {@link module:@monolith/tool-fs-search/grep}), result parsing,
 ...
 *
 * @module @monolith/tool-fs-search
 */
...
export interface Config {
   ...
   * `@monolith/tool-call-timeout-policy` through `exec.signal`.
   */
  timeoutMs?: number
}
