 ...
 *
 * @module @monolith/tool-fs-search/grep
 */

import type { Context } from '@monolith/cordis'
import { defineTool } from '@monolith/tools'
import type { GenericCallView, SearchResultView, ToolResult } from '@monolith/tools'
import type { RetainedItems } from '@monolith/output-retention'
import type { SpillRef } from '@monolith/spill'
