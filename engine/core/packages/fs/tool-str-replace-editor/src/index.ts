 ...
 * @module @monolith/tool-str-replace-editor
 */
...
import type { FsInfo, FsTarget, FsWriteIntent } from '@monolith/fs'
import { sandboxDenialMarker } from '@monolith/sandbox'
...
import type { ToolCallView, ToolRunContext } from '@monolith/tools'
