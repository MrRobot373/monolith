 ...
 * streams large files, and rejects binary data; line windows belong to `monolith-tool-fs`. Writes
 * stage an exclusive owner-only file in a private sibling directory and atomically publish it.
 * @module @monolith/fs-local/fsio
 */
...
import { FsError, FsTargetKey, FsVersion } from '@monolith/fs'
