...
const e2eMaxWorkers = positiveIntFromEnv('MONOLITH_E2E_MAX_WORKERS', DEFAULT_E2E_MAX_WORKERS)
...
export default defineConfig({
  ...
  test: {
    ...
    // API quotas (`MONOLITH_E2E_MAX_WORKERS=1` restores serial execution).
