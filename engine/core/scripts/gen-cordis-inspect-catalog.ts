...
import type { CordisCatalogModel, ServiceMethodEntry } from '@monolith/typert-generator'
...
function main(): void {
  ...
  const source = projector.renderRuntimeApi(clientModel(model))
    ...
    .replaceAll('@monolith/tool-cordis/api-catalog', '@monolith/cordis-client-runner/client/api-catalog')
