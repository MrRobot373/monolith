/**
 * Build the monolith executables and development Node carrier for the Python runtime wheel. The fixed
...
const DEPLOY_ROOT_PACKAGE = 'monolith-python-runtime-closure'
/** The sole application launcher inside the deployed closure. */
const ENTRY_BIN = 'node_modules/@monolith/cli/lib/bin.js'
/** Python-visible executable basename. */
const OUTPUT_BASENAME = 'monolith-sdk-runtime'
/** Default Node major; SEA mode requires at least Node 22. */
const DEFAULT_NODE_RANGE = 'node24'
const OUT_DIR = 'dist-exe'
/** Python package destination; created when absent. */
const PYTHON_RUNTIME_DIR = 'python/sdk-runtime/src/monolith_runtime/runtime'
...
const ASSET_GLOBS = [
  ...
  'node_modules/@monolith/web-frontend/dist/**/*',
  // skill-badge resolves both Markdown and image resources through import.meta.url.
  'node_modules/@monolith/skill-badge/assets/**/*',
]
