...
export const TRANSLATION_SCOPE_GLOB_EXCLUDES = [
  ...
  'apps/web/dist/**',
  '.artifacts/**',
  'python/sdk-runtime/src/monolith_runtime/runtime/monolith-sdk-runtime-*/**',
  'python/sdk-runtime/src/monolith_runtime/runtime/node/**',
  'vendor/**',
]
...
function isTranslationSourceExcluded(file: string): boolean {
  ...
  return segments.some(segment => NON_SOURCE_DIRECTORIES.has(segment)
    ...
    || file.startsWith('python/sdk-runtime/src/monolith_runtime/runtime/monolith-sdk-runtime-')
    || file.startsWith('python/sdk-runtime/src/monolith_runtime/runtime/node/')
}
...
const PUBLIC_REPOSITORY_BLOB_ROOT = 'https://github.com/MrRobot373/monolith/blob/master/'
