...
import { SessionSeq, type SessionEvent } from '@monolith/session'
...
describe('isPhysicalSessionFixture', () => {
  it('recognizes fixtures that preserve physical persistence encoding', () => {
    expect(isPhysicalSessionFixture(
      'packages/experimental/webworker-runtime/tests/fixtures/vfs-example/home/sessions/--monolith-workspace--/main/session.jsonl',
    )).toBe(true)
    expect(isPhysicalSessionFixture(
