---
name: office-inspect
description: Identify what a file actually is from its bytes, flag extension mismatches, and name the right tool for it. Run this first on any user-supplied document, spreadsheet, deck, PDF or data file of unknown provenance.
