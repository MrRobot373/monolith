...
export function OpenworkRouteControlActions() {
  ...
  const actions = useMemo<OpenworkControlAction[]>(() => [
    ...
    },
    {
      ...
      label: "What can MONOLITH do?",
      description: "List the main capabilities of MONOLITH.",
      sideEffect: "none",
      execute: () => ({
        capabilities: [
          ...
          { id: "voice", label: "Voice mode", description: "Talk to MONOLITH with real-time voice using OpenAI Realtime." },
