  ...
  return (
    <div className="rounded-xl border border-blue-6/30 bg-blue-3/20 p-3">
      <div className="mb-2 flex items-center justify-between gap-3">
        <div>
          <div className="text-[11px] font-semibold uppercase tracking-wider text-blue-11">Engine execution</div>
          <div className="text-[11px] text-dls-secondary">Command, working directory, and MONOLITH-injected environment.</div>
        </div>
