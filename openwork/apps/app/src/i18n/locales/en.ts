...
export default {
  "monolith.home.headline": "Let's knock something off your list",
  "monolith.home.notice": "MONOLITH runs tasks in your workspace. New improvements ship frequently.",
  "monolith.home.pick_any": "Pick a task, any task",
  "monolith.home.input_placeholder": "How can I help you today?",
  "monolith.home.start": "Start task",
  "monolith.home.workspace_fallback": "This workspace",
  "monolith.home.hint": "Enter to start · Shift+Enter for a new line",
  "monolith.home.no_provider_body": "Add an AI model so your tasks can run.",
  "monolith.tabs.aria": "Mode",
  "monolith.tabs.chat": "Chat",
  "monolith.tabs.cowork": "Cowork",
  "monolith.tabs.code": "Code",
  "monolith.nav.new_task": "New task",
  "monolith.nav.projects": "Projects",
  "monolith.nav.scheduled": "Scheduled",
  "monolith.nav.customize": "Customize",
  "monolith.nav.dispatch": "Dispatch",
  "monolith.nav.soon": "Soon",
  "monolith.nav.beta": "Beta",
  "monolith.nav.admin": "Admin",
  "monolith.admin.title": "Organization",
  "monolith.admin.subtitle": "Capabilities, members, and usage for this MONOLITH deployment.",
  "monolith.admin.capabilities": "Capabilities",
  "monolith.admin.web_search": "Web search",
  "monolith.admin.web_search_hint": "Allow tasks to search the web via the built-in search tools.",
  "monolith.admin.approval_mode": "Approval mode",
  "monolith.admin.approval_mode_hint": "Whether risky actions need explicit approval.",
  "monolith.admin.approval_manual": "Ask first",
  "monolith.admin.approval_auto": "Auto-approve",
  "monolith.admin.capabilities_note": "Settings are recorded in org.json and applied when workspaces are provisioned (add-user).",
  "monolith.admin.members": "Members",
  "monolith.admin.members_empty": "Single-user deployment — members appear here once provisioned with add-user.sh.",
  "monolith.admin.members_note": "Members are managed with scripts/add-user.sh (one container per user).",
  "monolith.admin.usage": "Usage",
  "monolith.admin.total_spend": "Total gateway spend",
  "monolith.admin.usage_unavailable": "Usage requires the LiteLLM gateway (Docker deployment).",
  "monolith.dispatch.failed": "Couldn't open the Dispatch thread",
  "monolith.notify.needs_input": "A task needs your input",
  "monolith.notify.finished": "Task finished",
  "monolith.projects.title": "Projects",
  "monolith.projects.subtitle": "Each project is a folder with its own tasks, context, and instructions.",
  "monolith.projects.back": "All projects",
  "monolith.projects.open": "Open project",
  "monolith.projects.tasks": "Tasks",
  "monolith.projects.kind": "Type",
  "monolith.projects.kind_local": "Local folder",
  "monolith.projects.kind_remote": "Remote",
  "monolith.projects.task_count_one": "{count} task",
  "monolith.projects.task_count_other": "{count} tasks",
  "monolith.projects.instructions": "Instructions",
  "monolith.projects.instructions_loading": "Loading instructions…",
  "monolith.projects.instructions_placeholder": "Standing instructions for every task in this project (tone, format, rules…)",
  "monolith.projects.instructions_hint": "Saved to AGENTS.md — the agent reads it at the start of every task.",
  "monolith.projects.save": "Save",
  "monolith.projects.saving": "Saving…",
  "monolith.projects.new": "New project",
  "monolith.projects.new_hint": "Start from scratch or use an existing folder",
  "monolith.projects.empty": "No projects yet — create one to get started.",
  "monolith.question.skip": "Skip",
  "monolith.question.submitting": "Submitting…",
  "monolith.question.keys_hint": "↑↓ to navigate · Enter to select · Esc to skip",
  "monolith.sched.title": "Scheduled tasks",
  "monolith.sched.subtitle": "Recurring tasks run in the background and land in your task list.",
  "monolith.sched.new": "New scheduled task",
  "monolith.sched.name_placeholder": "Name (e.g. Morning digest)",
  "monolith.sched.prompt_placeholder": "What should run on schedule? (e.g. Summarize new files in this folder)",
  "monolith.sched.type_every": "Every N minutes",
  "monolith.sched.type_daily": "Daily",
  "monolith.sched.type_weekly": "Weekly",
  "monolith.sched.minutes": "Minutes",
  "monolith.sched.create": "Schedule",
  "monolith.sched.default_name": "Scheduled task",
  "monolith.sched.paused": "Paused",
  "monolith.sched.pause": "Pause",
  "monolith.sched.resume": "Resume",
  "monolith.sched.run_now": "Run now",
  "monolith.sched.next_run": "next run",
  "monolith.sched.in": "in {time}",
  "monolith.sched.ago": "{time} ago",
  "monolith.sched.every_minutes": "Every {count} min",
  "monolith.sched.daily_at": "Daily at {time}",
  "monolith.sched.weekly_at": "Weekly on {day} at {time}",
  "monolith.sched.day_sun": "Sunday",
  "monolith.sched.day_mon": "Monday",
  "monolith.sched.day_tue": "Tuesday",
  "monolith.sched.day_wed": "Wednesday",
  "monolith.sched.day_thu": "Thursday",
  "monolith.sched.day_fri": "Friday",
  "monolith.sched.day_sat": "Saturday",
  "monolith.sched.open_session": "Open session",
  "monolith.sched.empty": "No scheduled tasks yet.",
  "monolith.sched.sidecar_missing": "The MONOLITH scheduler isn't reachable. Restart the launcher (native) or check the monolith-server service (Docker).",
  "monolith.notifications.title": "Notifications",
  "monolith.notifications.subtitle": "Choose what MONOLITH notifies you about.",
  "monolith.notifications.task_completed_title": "Task completed",
  "monolith.notifications.task_completed_desc": "Notify me when a background task finishes.",
  "monolith.notifications.needs_input_title": "Needs your input",
  "monolith.notifications.needs_input_desc": "Notify me when a task is waiting on a question or approval.",
  "monolith.notifications.scheduled_failures_title": "Scheduled task failures",
  "monolith.notifications.scheduled_failures_desc": "Notify me when a scheduled task run fails.",
  "monolith.notifications.browser_push_title": "Browser notifications",
  "monolith.notifications.browser_push_desc": "Also show a system notification, even when this tab isn't focused.",
  "monolith.notifications.browser_push_blocked": "Blocked in browser settings.",
  "monolith.notifications.browser_push_blocked_hint": "Notifications are blocked for this site in your browser. Allow them in your browser's site settings to enable this.",
  "monolith.usage.title": "Usage",
  "monolith.usage.subtitle": "Model gateway spend for this deployment.",
  "monolith.usage.loading": "Loading usage…",
  "monolith.usage.total_spend": "Total spend",
  "monolith.usage.refresh": "Refresh",
  "monolith.usage.by_model": "By model",
  "monolith.usage.unlabeled_model": "Other",
  "monolith.usage.local_note": "Local models served by Ollama are free and unlimited — only cloud gateway calls are metered above.",
  "monolith.usage.sidecar_missing": "The MONOLITH sidecar isn't reachable.",
  "monolith.usage.gateway_unavailable": "Usage tracking requires the Docker deployment with the LiteLLM gateway configured.",
  "monolith.mcp.title": "MCP Servers",
  "monolith.mcp.subtitle": "Connect tools like GitHub, Gmail, Excel, and Slack to your agent. Servers you enable are yours alone.",
  "monolith.mcp.loading": "Loading catalog…",
  "monolith.mcp.sidecar_missing": "The MONOLITH sidecar isn't reachable.",
  "monolith.mcp.enabled": "Enabled",
  "monolith.mcp.enabled_count": "{count} enabled.",
  "monolith.mcp.always_on": "Always on",
  "monolith.mcp.enable": "Enable",
  "monolith.mcp.enabling": "Enabling…",
  "monolith.mcp.disable": "Disable",
  "monolith.mcp.cancel": "Cancel",
  "monolith.mcp.docs": "Documentation",
  "monolith.mcp.secret_note": "Keys are stored on your server and never shown again.",
  "monolith.mcp.apply_note": "Changes apply to new workspaces immediately; existing workspaces pick them up after re-seeding (re-open the workspace or restart MONOLITH).",
  "monolith.chat.title": "Chat",
  "monolith.chat.new_chat": "New chat",
  "monolith.chat.no_chats": "No chats yet. Start one to see smart routing in action.",
  "monolith.chat.empty_thread": "Send a message. The router picks a cheap or smart model per message automatically.",
  "monolith.chat.auto_route_label": "Auto-route",
  "monolith.chat.auto_route_hint": "Let a tiny model pick the cheapest model that can handle each message.",
  "monolith.chat.routed_badge": "Auto-routed → {model} ({tier})",
  "monolith.chat.model_caption": "Model: {model}",
  "monolith.chat.tier_small": "small",
  "monolith.chat.tier_large": "large",
  "monolith.chat.input_placeholder": "Ask anything…",
  "monolith.chat.send": "Send",
  "monolith.chat.stop": "Stop",
  "monolith.chat.thinking": "Thinking…",
  "monolith.chat.delete": "Delete",
  "monolith.chat.sign_in_required": "Sign in to MONOLITH to use chat.",
  "monolith.chat.palette_title": "Open Chat",
  "monolith.chat.palette_detail": "Cost-saving smart-router chat",
  "monolith.rail.title": "Task",
  "monolith.rail.close": "Close task panel",
  "monolith.rail.progress": "Progress",
  "monolith.rail.progress_empty": "Steps will show as the task unfolds.",
  "monolith.rail.artifacts": "Artifacts",
  "monolith.rail.artifacts_empty": "Outputs created during the task land here.",
  "monolith.rail.context": "Context",
  "monolith.rail.context_folders": "Selected folders",
  ...
  "monolith.account.title": "Account",
  "monolith.account.local_user": "Account",
  "monolith.account.settings": "Settings",
  "monolith.account.not_signed_in": "Not signed in",
  "monolith.account.not_configured_desc": "Account sign-in is not set up for this deployment.",
  "monolith.account.not_configured_body": "Set these environment variables at build time to enable sign-in:",
  "monolith.account.loading": "Loading account…",
  "monolith.account.signed_in_desc": "You're signed in to MONOLITH.",
  "monolith.account.signed_in_label": "Signed in",
  "monolith.account.sign_out": "Sign out",
  "monolith.account.signin_title": "Sign in",
  "monolith.account.signup_title": "Create an account",
  "monolith.account.signed_out_desc": "Sign in or create an account to continue.",
  "monolith.account.email_label": "Email",
  "monolith.account.password_label": "Password",
  "monolith.account.password_hint": "Use at least 8 characters.",
  "monolith.account.error_required": "Enter your email and password.",
  "monolith.account.signup_check_email": "Check your email to confirm your account.",
  "monolith.account.working": "Working…",
  "monolith.account.sign_in": "Sign in",
  "monolith.account.sign_up": "Create account",
  "monolith.account.switch_to_signup": "Need an account? Sign up",
  "monolith.account.switch_to_signin": "Already have an account? Sign in",
  "monolith.status.working": "Working…",
  "monolith.status.needs_input": "Needs your input",
  "monolith.status.failed": "Needs attention",
  "monolith.suggest.organize.title": "Organize my files",
  "monolith.suggest.organize.prompt": "Look at the files in this workspace, propose a tidy folder structure, and after I confirm, organize them (rename with consistent names where it helps).",
  "monolith.suggest.insights.title": "Find insights in files",
  "monolith.suggest.insights.prompt": "Read through the documents in this workspace and give me a summary of key findings, surprises, and recommended follow-ups.",
  "monolith.suggest.create.title": "Create a file",
  "monolith.suggest.create.prompt": "Help me create a new document. Ask me what it's for (report, plan, notes…), draft it, and save it in this workspace.",
  "monolith.suggest.crunch.title": "Crunch data",
  "monolith.suggest.crunch.prompt": "Find the spreadsheet/CSV files in this workspace, analyze them, and produce a short report with the main numbers and trends.",
  "monolith.suggest.meeting.title": "Prep for a meeting",
  "monolith.suggest.meeting.prompt": "Help me prepare for an upcoming meeting: ask what it's about, then build an agenda, talking points, and a one-page brief from any relevant files here.",
  "monolith.suggest.draft.title": "Draft a message",
  "monolith.suggest.draft.prompt": "Help me draft a message. Ask who it's for and the goal, then write a clear draft and refine it with me.",
  ...
  "app.plugins_hint_readonly": "MONOLITH is read-only for plugins.",
  "app.reload_later": "Later",
  "app.reload_now": "Reload now",
  "app.reload_stop_tasks": "Reload & Stop Tasks",
  "app.skills_hint_readonly": "MONOLITH is read-only for skills. Add a host token in Advanced to enable installs.",
  ...
  "config.engine_reload_desc": "Restart the engine for this workspace.",
  ...
  "config.reload_availability_hint": "Reloading is only available for local workers or connected MONOLITH.",
  ...
  "config.server_needed_hint": "A MONOLITH connection is needed to sync skills, plugins, and commands.",
  "config.server_section_desc": "Connect to MONOLITH. Use the URL plus a collaborator or owner token from your server admin.",
  "config.server_section_title": "MONOLITH",
  ...
  "config.server_sharing_title": "MONOLITH sharing",
  "config.server_url_hint": "Use the URL shared by MONOLITH. Local desktop workers reuse a persistent high port in the 48000-51000 range.",
  "config.server_url_input_label": "MONOLITH server URL",
  "config.server_url_label": "MONOLITH Server URL",
  ...
  "context_panel.authorized_folders_no_access": "Connect to a writable MONOLITH workspace to edit authorized folders.",
  "context_panel.browse_button": "Browse",
  "context_panel.config_access_unavailable": "MONOLITH config access is unavailable for this workspace.",
  "context_panel.config_read_only": "MONOLITH is connected read-only for workspace config.",
  ...
  "context_panel.server_disconnected": "MONOLITH is disconnected.",
  ...
  "context_panel.writable_workspace_required": "A writable MONOLITH workspace is required to update authorized folders.",
  ...
  "dashboard.chooser_remote_desc": "Attach to a self-hosted MONOLITH worker using a URL and access token.",
  ...
  "dashboard.create_remote_custom_subtitle": "Attach to a self-hosted MONOLITH worker.",
  "dashboard.create_remote_custom_title": "Connect custom remote",
  "dashboard.create_remote_workspace_confirm": "Add Workspace",
  "dashboard.create_remote_workspace_subtitle": "Save MONOLITH as a workspace.",
  ...
  "dashboard.edit_remote_workspace_subtitle": "Update the MONOLITH details for this workspace.",
  ...
  "dashboard.remote_server_details_hint": "Attach to a self-hosted MONOLITH worker.",
  ...
  "identities.agent_behavior_desc": "One file per workspace. Add optional first line @agent <id> to route via a specific agent.",
  ...
  "identities.connect_server_desc": "Identities are available when you are connected to a MONOLITH host.",
  "identities.connect_server_title": "Connect to MONOLITH",
  ...
  "identities.reconnect_failed": "Reconnect failed. Check MONOLITH URL/token and try again.",
  ...
  "mcp.toggle_requires_server": "Connect to MONOLITH to enable or disable MCPs.",
  ...
  "mcp.apps_subtitle": "Connect your favorite tools so MONOLITH can use them on your behalf.",
  "mcp.apps_title": "Apps",
  ...
  "mcp.auth.reload_notice": "For this to take effect, MONOLITH needs to refresh the worker service. This can interrupt a running session.",
  "mcp.auth.reload_remote_confirm": "For this to take effect, MONOLITH needs to refresh the worker service. This might stop your running session. Continue?",
  ...
  "mcp.auth.step2_title": "Authorize MONOLITH",
  ...
  "mcp.login_unavailable": "This app does not support sign-in from MONOLITH.",
  ...
  "notifications.reconnect_failed": "Couldn't reconnect to the MONOLITH",
  ...
  "welcome.title": "Welcome to MONOLITH",
  ...
  "welcome.folder_explanation": "This folder becomes your workspace. MONOLITH will be able to:",
  ...
  "welcome.folder_drop_hint": "Drop files in anytime and MONOLITH can pick them up.",
  "plugins.add": "Add",
  ...
  "plugins.desc": "Manage `opencode.json` for your project or global plugins.",
  ...
  "providers.disabled_in_config_suffix": "and disabled it in the config.",
  ...
  "session.cmd_reload_config_title": "Reload config",
  ...
  "session.doom_loop_message": "MONOLITH detected repeated tool calls with identical input and is asking whether it should continue after repeated failures.",
  ...
  "session.permission_message": "MONOLITH is requesting permission to continue.",
  "session.permission_message_bash": "Review the command scope before allowing the agent to continue.",
  "session.permission_message_edit": "Review the file and diff before allowing the agent to make changes.",
  ...
  "session.share_local_host_not_ready": "Local MONOLITH host is not ready yet.",
  "session.share_missing_host_url": "Missing MONOLITH host URL.",
  "session.share_missing_token": "Missing MONOLITH token.",
  ...
  "session.share_openwork_workers_only": "Share service links are available for MONOLITH workers.",
  ...
  "settings.privacy_section_desc": "Control what MONOLITH shares to improve the product.",
  "settings.privacy_title": "Privacy",
  "settings.auto_compact_desc": "Controls compaction.auto for this workspace. Reload the engine after changing it.",
  ...
  "settings.capabilities_title": "MONOLITH capabilities",
  ...
  "settings.custom_binary_hint": "Use this to point MONOLITH at a local engine build",
  ...
  "settings.debug_openwork_server_version": "MONOLITH: {version}",
  ...
  "settings.enable_exa_desc": "Applies the next time the engine is restarted. Off by default.",
  ...
  "settings.feedback_title": "Help shape MONOLITH",
  ...
  "settings.open_deeplink_desc": "Paste an MONOLITH deeplink or share URL to open it.",
  ...
  "settings.opencode_engine_label": "Engine",
  "settings.opencode_engine_sidecar": "Engine",
  "settings.opencode_engine_sidecar_desc": "Local engine process managed by MONOLITH.",
  "settings.opencode_sdk_desc": "Browser → engine connection.",
  "settings.opencode_sdk_title": "Engine SDK link",
  "settings.opencode_section_label": "Engine",
  "settings.opening": "Open deeplink",
  "settings.openwork_config_sidecar_desc": "Local MONOLITH server (Bun) that hosts approvals, audit, and engine lifecycle.",
  "settings.openwork_diagnostics_title": "MONOLITH diagnostics",
  "settings.openwork_server_desc": "Session control plane for app sync, workers, and remote",
  "settings.openwork_server_label": "MONOLITH",
  ...
  "settings.quit_hint": "MONOLITH quits immediately after cleanup so the next launch starts from a blank local state for this mode.",
  ...
  "settings.reconnect_server_failed": "Failed to reconnect MONOLITH.",
  "settings.reconnected": "Reconnected to MONOLITH.",
  ...
  "settings.reset_app_data_description": "More aggressive. Clears MONOLITH cache + app data.",
  "settings.reset_app_data_title": "Reset app data",
  "settings.reset_app_data_warning": "Clears MONOLITH cache and app data on this device.",
  ...
  "settings.reset_confirmation_hint": "Type {resetWord} to confirm. MONOLITH will restart.",
  ...
  "settings.reset_onboarding_description": "Clears MONOLITH preferences and restarts the app.",
  "settings.reset_onboarding_title": "Reset onboarding",
  "settings.reset_onboarding_warning": "Clears MONOLITH local preferences and workspace onboarding markers.",
  "settings.reset_openwork_desc_dev": "With dev mode active, it only clears the isolated engine dev state inside openwork-dev-data.",
  "settings.reset_openwork_desc_prod": "With dev mode active, it only clears the isolated engine dev state inside openwork-dev-data.",
  "settings.reset_openwork_title": "Reset MONOLITH + engine state",
  ...
  "settings.restart_blocked_message": "The update is ready, but MONOLITH will wait until your active tasks finish before restarting. You can also stop them manually.",
  "settings.restart_failed": "Restart failed. Check logs and try again.",
  "settings.restart_opencode": "Restart engine",
  "settings.restart_openwork_server": "Restart MONOLITH",
  ...
  "settings.services_section_desc": "Local services that power this MONOLITH session. Each service has its own restart and logs.",
  ...
  "settings.recovery_section_desc": "Roll back state without quitting MONOLITH.",
  ...
  "settings.runtime_desc": "Status for your local engine and MONOLITH.",
  ...
  "settings.tab_description_appearance": "Adjust how MONOLITH looks across desktop, system theme, and app frame.",
  "settings.tab_description_cloud_account": "Sign in or create an account.",
  ...
  "settings.tab_description_extensions": "Manage MCP apps and plugins for this workspace.",
  "settings.tab_description_general": "Connect providers, choose the default model, authorize folders, and control the selected MONOLITH workspace plus its runtime connection.",
  ...
  "settings.environment.footer_hint": "OPENWORK_ and OPENCODE_ keys are reserved for app/runtime wiring. Configure engine runtime settings from your shell.",
  "settings.environment.override_hint": "Environment variables set before MONOLITH starts take precedence over values saved here.",
  ...
  "settings.environment.apply_confirm_body": "MONOLITH will restart local agents so they can use the latest environment. Running local tasks may stop.",
  "settings.environment.apply_no_local_workspace": "MONOLITH is not connected to a local workspace.",
  ...
  "settings.environment.apply_refresh_failed": "Changes are active, but MONOLITH status did not refresh. Reopen the app if it looks stale.",
  ...
  "settings.environment.validation_reserved": "OPENWORK_ and OPENCODE_ names are managed by MONOLITH.",
  ...
  "settings.update_restart_active_tasks": "You have active tasks. Installing the update restarts MONOLITH and will interrupt them.",
  "settings.update_restart_confirm_title": "Restart with active tasks?",
  "settings.update_restart_confirm_message": "Installing the update restarts MONOLITH now and interrupts your active tasks. You may need to resume them after the update.",
  "settings.update_uptodate": "You're up to date",
  "settings.updates": "Updates",
  "settings.updates_desc": "Keep MONOLITH up to date.",
  ...
  "share_skill_destination.connect_remote_hint": "Attach a MONOLITH host, then choose it from the list to import this skill.",
  ...
  "skills.add_openwork_hub": "Add Skill Hub",
  ...
  "skills.host_only_error": "Skill management requires a local workspace or connected MONOLITH.",
  ...
  "status.limited_hint": "Reconnect to restore full MONOLITH features",
  ...
  "status.openwork_ready": "MONOLITH Ready",
  ...
  "status.reloading_config": "Reloading config",
  "status.running": "Running",
  "status.send_feedback": "Send feedback",
  "status.settings": "Settings",
  "system.reload_body_agents": "MONOLITH loads agents at startup. Reload the engine to make updated agents available.",
  "system.reload_body_commands": "MONOLITH loads commands at startup. Reload the engine to make updated commands available.",
  "system.reload_body_config": "MONOLITH reads opencode.json at startup. Reload the engine to apply configuration changes.",
  "system.reload_body_default": "MONOLITH detected changes that require reloading the engine.",
  "system.reload_body_mcp": "MONOLITH loads MCP servers at startup. Reload the engine to activate the new connection.",
  "system.reload_body_mixed": "MONOLITH detected configuration changes. Reload the engine to apply them.",
  "system.reload_body_plugins": "MONOLITH loads npm plugins at startup. Reload the engine to apply opencode.json changes.",
  "system.reload_body_skills": "MONOLITH can cache skill discovery/state. Reload the engine to make newly installed skills available.",
  ...
  "workspace_list.remote_worker_unavailable_hint": "MONOLITH can't load tasks from this worker until the connection is fixed.",
