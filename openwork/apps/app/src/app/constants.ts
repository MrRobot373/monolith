...
export const MCP_QUICK_CONNECT: McpDirectoryInfo[] = [
  ...
  },
  {
    name: "GitHub",
    serverName: "github",
    description: "Access and automate GitHub repositories, search code, manage issues, pull requests, and commits.",
    type: "local",
  ...
  },
  {
    name: "PostgreSQL",
    serverName: "postgres",
    description: "Connect to any PostgreSQL database to view schemas, run SQL queries, and manage database records.",
    type: "local",
  ...
  },
  {
    name: "SQLite",
    serverName: "sqlite",
    description: "Query and inspect local SQLite database files (.db or .sqlite) directly in your workspace.",
    type: "local",
  ...
  },
  {
    name: "Git",
    serverName: "git",
    description: "Automate version control: inspect git repository status, diffs, commits, branches, and logs.",
    type: "local",
  ...
  },
  {
    ...
    description: "Search and fetch articles, summaries, and definitions directly from Wikipedia.",
    type: "local",
