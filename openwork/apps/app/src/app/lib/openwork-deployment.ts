export const OPENWORK_DEPLOYMENT_ENV_VAR = "VITE_MONOLITH_DEPLOYMENT";
...
export function getOpenWorkDeployment(): OpenWorkDeployment {
  const envValue =
    typeof import.meta !== "undefined" && typeof import.meta.env?.VITE_MONOLITH_DEPLOYMENT === "string"
      ? import.meta.env.VITE_MONOLITH_DEPLOYMENT
      : undefined;
